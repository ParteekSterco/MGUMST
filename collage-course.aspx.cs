...
public partial class collage_course : System.Web.UI.Page
{
    ...
    protected void rptcourselevel_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        if (e.Item.ItemType == ListItemType.Item | e.Item.ItemType == ListItemType.AlternatingItem)
        {
            ...
            ank.HRef = "/collage-course.aspx?mpgid="+ Conversion.Val(Request.QueryString["pgidtrail"]) + "&pgidtrail="+ Conversion.Val(Request.QueryString["pgidtrail"]) + "&levelid=" + Conversion.Val(litlevelid.Text) + "&collageid=" + Conversion.Val(Request.QueryString["collageid"]);

            ankall.HRef = "/collage-course.aspx?mpgid=" + Conversion.Val(Request.QueryString["pgidtrail"]) + "&pgidtrail=" + Conversion.Val(Request.QueryString["pgidtrail"]) + "&levelid=all&collageid=" + Conversion.Val(Request.QueryString["collageid"]);
        }
    }
