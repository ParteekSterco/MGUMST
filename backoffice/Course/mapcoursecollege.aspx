<%@ Page Language="C#" AutoEventWireup="true" CodeFile="mapcoursecollege.aspx.cs" Theme="backtheme" Inherits="backoffice_Course_mapcoursecollege" %>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        ...
        <tr style="display:none">
            <td colspan="2" align="center" >
               <asp:DropDownList ID="campusid" runat="server" >
        </asp:DropDownList>
            </td>
        </tr>
        <tr>
