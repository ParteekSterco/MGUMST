<%@ Page Language="C#" AutoEventWireup="true" CodeFile="mapcourse_testimonials.aspx.cs"
                ...
                <table border="0" cellpadding="2" cellspacing="2" width="80%">
                    ...
                    <tr>
                        <td align="right" style="width: 15%" valign="top">
                            Testimonials: <span class="star">*</span> :&nbsp;
                        </td>
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                            <tr>
                                                <td width="90%" align="left">
                                                    ...
                                                    <asp:Label ID="lbltestimonial" runat="server" Text='<%#Eval("Testimonialname")%>'
