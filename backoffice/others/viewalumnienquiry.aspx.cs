...
public partial class backoffice_others_viewalumnienquiry : System.Web.UI.Page
{
    ...
    private void Search()
    {
        try
        {
            string Strsql = "SELECT  e.eid,e.fname[Name],e.Emailid[Email],e.Mobile,e.city[City],e.coursename[CourseName],fmessage[Message],e.trdate FROM enquiry_alumni  e where 1=1  ";
            Parameters.Clear();
    ...
    {
        string Strsql = "SELECT  e.eid,e.fname[Name],e.Emailid[Email],e.Mobile,e.city[City],e.coursename[CourseName],e.yearpassout [Year Passout],e.dob [Date of birth],fmassage[Message],e.trdate FROM enquiry_alumni  e where 1=1  ";
        Parameters.Clear();
        ...
        Response.AddHeader("content-disposition", "attachment;filename=AdmissionEnquiry.xls");
        Response.Charset = "";
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName == "btndel")
        {
            ...
            clsm.ExecuteQry_Parameter("delete from enquiry_alumni where eid=@eid", Parameters);
