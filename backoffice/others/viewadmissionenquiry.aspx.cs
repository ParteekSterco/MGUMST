...
public partial class backoffice_others_viewadmissionenquiry : System.Web.UI.Page
{
    ...
    private void Search()
    {
        try
        {
            string Strsql = "SELECT  e.eid,e.name[Name],e.Emailid[Email],e.Mobile,e.city[City],e.levelname[Levelname],e.coursename[CourseName],etype[EnqType],massage[Message],e.trdate FROM admission_enquiry  e where 1=1  ";
            Parameters.Clear();
            ...
            if (QueryType.SelectedValue !="0")
            {
                Parameters.Add("@etype",QueryType.SelectedValue);
                Strsql += " and e.etype=@etype";
            }
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName == "btndel")
        {
            ...
            clsm.ExecuteQry_Parameter("delete from admission_enquiry where eid=@eid", Parameters);
