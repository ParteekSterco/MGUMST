<%@ Page Title="" Language="C#" MasterPageFile="~/backoffice/layouts/BackMaster.master" Theme="backtheme" AutoEventWireup="true" CodeFile="viewadmissionenquiry.aspx.cs" Inherits="backoffice_others_viewadmissionenquiry" %>
            ...
            <td align="center" colspan="2">
                <asp:GridView ID="GridView1" runat="server" Width="100%" AllowPaging="True" PageSize="50" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="EnqType" HeaderText="Enq.Type" />
                        ...
                        <asp:TemplateField HeaderText="Details" meta:resourcekey="TemplateFieldResource3">
                            ...
                            <ItemTemplate>
                                <a id='various<%# ((GridViewRow)Container).RowIndex + 1 %>' class="toptxt" visible="false"
                                    href='viewadmissionenquirydetails.aspx?&eid=<%#Eval("eid")%>'>
