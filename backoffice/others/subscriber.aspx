<%@ Page Language="C#" MasterPageFile="~/backoffice/layouts/BackMaster.master"  AutoEventWireup="true" CodeFile="subscriber.aspx.cs" Inherits="backoffice_others_subscriber" Theme="backtheme"%>
                                ...
                                <table id="Table3" border="0" cellpadding="2" cellspacing="0" class="panelbg" width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <td align="left" width="20%">
                                            <asp:TextBox ID="txtemail" runat="server" CssClass="box" Width="200px"></asp:TextBox>
                                        </td>
                                        <td align="right" width="20%">College
                                        </td>
                                        <td align="left" width="30%">
                                            <asp:DropDownList ID="drpcollege" runat="server">
                                            </asp:DropDownList>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td align="center" colspan="4">
                                            ...
                                            <asp:Button ID="btnExport" runat="server" Text="Export To Excel" CssClass="btnbg" OnClick="btnExport_Click" />
                                        </td>
                                    </tr>
                                    <tr>
                ...
                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" PageSize="50" Width="100%"
                    ...
                    <Columns>
                       ...
                       <asp:TemplateField HeaderText="College">
                        ...
                        <asp:TemplateField HeaderText="Subscribe Date">
                            <HeaderStyle HorizontalAlign="Center" Width="15%" />
                            <ItemStyle HorizontalAlign="Center" VerticalAlign="top" />
                            <ItemTemplate>
                                <asp:Label ID="lbldate" runat="server" Text='<%#Eval("trdate") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                         <asp:TemplateField HeaderText="Publish" Visible="false">
                            ...
                            <asp:TextBox ID="txtstatus" runat="server" Text='<%# Eval("status") %>' Visible="false"></asp:TextBox>
                                <asp:ImageButton ID="lnkstatus" runat="server" CausesValidation="false" CommandArgument='<%# Eval("subid") %>'
                        ...
                        <asp:TemplateField HeaderText="Delete">
                            ...
                            <ItemStyle HorizontalAlign="Center" VerticalAlign="top" />
                            <ItemTemplate>
                                <asp:ImageButton ID="btndel" runat="server" CausesValidation="false" CommandArgument='<%#Eval("subid")%>'
