                        ...
                        <tr style="display: none">
                         ...
                         <tr>
                                        ...
                                        <td align="left" width="20%">
                                            <asp:TextBox ID="txtemailid" runat="server" CssClass="box" Width="200px"></asp:TextBox>
                                        </td>
            ...
            <td align="center" colspan="2">
                <asp:GridView ID="GridView1" runat="server" Width="100%" AllowPaging="True" PageSize="50" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="collagename" HeaderText="Collage" ItemStyle-Width="15%" Visible="true">
