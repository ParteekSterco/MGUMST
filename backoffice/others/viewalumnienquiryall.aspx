<%@ Page Title="" Language="C#" MasterPageFile="~/backoffice/layouts/BackMaster.master" Theme="backtheme" AutoEventWireup="true" CodeFile="viewalumnienquiryall.aspx.cs" Inherits="backoffice_others_viewalumnienquiryall" %>
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="Trdate" DataFormatString="{0: dd/MM/yyyy}" HeaderText="Enquiry Date"
                          ...
                          <asp:TemplateField HeaderText="Download File" Visible="true">
                            <ItemStyle Width="8%" />
                            <ItemTemplate>              
                            <asp:Literal ID="lbldown" runat="server" Text='<%#Eval("yearofadmission")%>' Visible="false"></asp:Literal>                                                  
                                <asp:LinkButton ID="downbtn" runat="server" CausesValidation="false" CommandArgument='<%# Eval("eid") %>'
                                    CommandName="downbtn">
                                    <asp:Image ID="imgDown" runat="server" BorderWidth="0" ImageUrl="~/backoffice/assets/Download_24x24.png" Visible="false" /></asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Details" meta:resourcekey="TemplateFieldResource3" Visible="false">
                            <HeaderStyle HorizontalAlign="Center" Width="3%" />
                            <ItemStyle HorizontalAlign="Center" VerticalAlign="Top" />
                            <ItemTemplate>
                                <a id='various<%# ((GridViewRow)Container).RowIndex + 1 %>' class="toptxt" visible="false"
                                    href='viewalumnienquirydetails.aspx?&eid=<%#Eval("eid")%>'>
