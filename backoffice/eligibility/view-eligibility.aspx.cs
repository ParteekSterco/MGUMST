...
public partial class backoffice_eligibility_view_eligibility : System.Web.UI.Page
{
    ...
    protected void griddata()
    {
        ...
        Parameters.Clear();
        strq2 = "Select * from eligibility t where 1=1  ";
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName == "del")
        {
            ...
            Parameters.Clear();
            Parameters.Add("@eid", e.CommandArgument.ToString());
            clsm.ExecuteQry_Parameter("delete from eligibility where eid=@eid", Parameters);
            griddata();
            trsuccess.Visible = true;
        ...
        if (e.CommandName == "status")
        {
            ...
            if (txtstatus.Text == "False")
            {
                Parameters.Clear();
                Parameters.Add("@eid", e.CommandArgument.ToString());
                clsm.ExecuteQry_Parameter("update eligibility set status=1 where eid=@eid", Parameters);
            }
            else if (txtstatus.Text == "True")
            {
                Parameters.Clear();
                Parameters.Add("@eid", e.CommandArgument.ToString());
                clsm.ExecuteQry_Parameter("update eligibility set status=0 where eid=@eid", Parameters);
            }
            griddata();
            trsuccess.Visible = true;
        ...
        {
            Response.Redirect("add-eligibility.aspx?eid=" + Convert.ToString(e.CommandArgument));
