<%@ Page Title="" Language="C#" MasterPageFile="~/backoffice/layouts/BackMaster.master"
    Theme="backtheme" AutoEventWireup="true" CodeFile="add-eligibility.aspx.cs" ValidateRequest="false" Inherits="backoffice_eligibility_add_eligibility" %>
        ...
        <table id="TABLE1" border="0" cellpadding="1" cellspacing="0" style="width: 100%">
                ...
                <td align="left" colspan="2">
                    <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                        <tr>
                            <td align="right">
                                &nbsp;
                                <asp:TextBox ID="eid" runat="server" Visible="False" Width="33px"></asp:TextBox>
            ...
            <tr>
                ...
                <td align="left" style="width: 85%">
                    <asp:TextBox ID="title" runat="server" CssClass="box" TabIndex="3" Width="359px"></asp:TextBox>
