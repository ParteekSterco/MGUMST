<%@ Page Title="" Language="C#" MasterPageFile="~/backoffice/layouts/BackMaster.master" AutoEventWireup="true" CodeFile="notification.aspx.cs" Inherits="backoffice_notification_notification" Theme="backtheme" ValidateRequest="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="content-panel">
        <table id="TABLE1" border="0" cellpadding="1" cellspacing="0" style="width: 100%">
            ...
            <tr>
                <td align="center" colspan="2" height="10">
                     <asp:CompareValidator ID="CompareValidator1" runat="server" ErrorMessage="Event start date must be before/equal than end date"
            ...
            <tr>
                <td align="right">
                   Notificatio Start Date<span class="star"></span> :&nbsp;
                </td>
                <td align="left">
        ...
        <tr>
            ...
            <tr >
                <td align="right">
                    Notificatio End Date<span class="star">*</span> :&nbsp;
                </td>
                <td align="left">
                    <asp:TextBox ID="eventedate" runat="server" CssClass="box" Width="200px" ></asp:TextBox>
            ...
            <tr>
                ...
                <td align="left" colspan="3">
                    ...
                    &nbsp;<asp:Label ID="Label5" runat="server" Text="(Upload file for Press Release/Notification)"
                        ForeColor="red" Font-Italic="true"></asp:Label>
