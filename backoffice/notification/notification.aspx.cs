...
public partial class backoffice_notification_notification : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            Eventsdate.Text = DateTime.Now.ToString("MM/dd/yyyy");
            eventedate.Text = DateTime.Now.AddYears(30).ToString("MM/dd/yyyy"); 
    ...
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (Eventsid.Text == "")
            {
                ...
                Response.Redirect("notification.aspx?add=add");
            ...
            else
            {
                ...
                if (File1.PostedFile.FileName != "")
                {
                    UploadEvents.Text = HttpUtility.HtmlEncode(Path.GetFileName( Path.GetFileName(File1.PostedFile.FileName.Replace(" ", "")).Replace("&", "")));
                ...
                Response.Redirect("viewnotification.aspx?edit=edit");
            }
        }
        catch (Exception ex)
        {
