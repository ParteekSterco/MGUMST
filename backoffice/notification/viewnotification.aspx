<%@ Page Title="" Language="C#" MasterPageFile="~/backoffice/layouts/BackMaster.master" AutoEventWireup="true" CodeFile="viewnotification.aspx.cs" Inherits="backoffice_notification_viewnotification" Theme="backtheme" %>
                        ...
                        <tr>
                         ...
                         <tr>
                          <td align="right">
                            ...
                            <td align="left" >
                                <asp:DropDownList ID="ddlcampus" runat="server" CssClass="box" Width="200px" 
                          ...
                          <td align="right">
                            ...
                            <td >
                                <asp:DropDownList ID="ddlcollege" runat="server" CssClass="box" Width="200px">
                                </asp:DropDownList>
            ...
            <td align="center" colspan="2">
                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" PageSize="50" Width="100%"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Notification Start Date">
                            <ItemStyle Width="8%" />
                            <ItemTemplate>
                                <%#Eval("eventsdate", "{0:dd/MM/yyyy}")%>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Notification End Date">
                            <ItemStyle Width="8%" />
                            <ItemTemplate>
                                <%#Eval("eventedate", "{0:dd/MM/yyyy}")%>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Show on Group" Visible="true">
                         ...
                         <asp:TemplateField HeaderText="Show on Top" Visible="true">
                            <HeaderStyle HorizontalAlign="Center" Width="10%" />
                            <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                            <ItemTemplate>
                            ...
                            <ItemTemplate>
                                ...
                                <asp:Panel runat="server" ID="pnl_gallery" Visible="false">
                                    <a id='various2<%# ((GridViewRow)Container).RowIndex + 1 %>' class="toptxt" visible="false"
                                        href='event_gallery.aspx?Eventsid=<%#Eval("Eventsid")%>'>
                                        <img border="0" src="../assets/Text Document_24x24.png" alt="" />
                                    </a>
                                </asp:Panel>
                            </ItemTemplate>
