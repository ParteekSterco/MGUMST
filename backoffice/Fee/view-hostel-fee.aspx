<%@ Page Title="" Language="C#" MasterPageFile="~/backoffice/layouts/BackMaster.master" AutoEventWireup="true" CodeFile="view-hostel-fee.aspx.cs" Inherits="backoffice_Fee_view_hostel_fee" Theme="backtheme" %>
                            ...
                            <ItemTemplate>
                                ...
                                <asp:Panel runat="server" ID="pnl_gallery" Visible="true">
                                    <a class="toptxttest1" visible="false"
                                        href='map_course_hostelfee.aspx?cfid=<%#Eval("cfid")%>'>
