<%@ Page Title="" Language="C#" MasterPageFile="~/backoffice/layouts/BackMaster.master" Theme="backtheme" AutoEventWireup="true" CodeFile="view-course-fee.aspx.cs" Inherits="backoffice_Fee_view_course_fee" %>
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Display Order">
                         ...
                         <asp:TemplateField HeaderText="Map Course" Visible="true">
                            ...
                            <ItemTemplate>
                                <asp:Literal Text='<%# Eval("cfid")%>' ID="litcid" Visible="false" runat="server" />
                                <asp:Panel runat="server" ID="pnl_gallery" Visible="true">
                                    <a class="toptxttest1" visible="false"
                                        href='map_course_feestructure.aspx?cfid=<%#Eval("cfid")%>'>
                        ...
                        <asp:TemplateField HeaderText="Publish">
                            ...
                            <asp:TextBox ID="txtstatus" runat="server" Text='<%#Eval("Status") %>'
                                ...
                                <asp:ImageButton ID="lnkstatus" CssClass="toptxt" runat="server" CausesValidation="false"
                                    CommandArgument='<%#Eval("cfid") %>' CommandName="status"></asp:ImageButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Edit">
                            ...
                            <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                            <ItemTemplate>
                                <asp:ImageButton ID="btnedit" runat="server" CausesValidation="false" CommandArgument='<%#Eval("cfid") %>'
                        ...
                        <asp:TemplateField HeaderText="Delete" >
                            ...
                            <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                            <ItemTemplate>
                                <asp:ImageButton ID="btndel" runat="server" CausesValidation="false" CommandArgument='<%# Eval("cfid") %>'
