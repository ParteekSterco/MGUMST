<%@ Page Title="" Language="C#" MasterPageFile="~/backoffice/layouts/BackMaster.master"
    AutoEventWireup="true" CodeFile="addpagesdept.aspx.cs" Inherits="backoffice_department_addpagesdept"
        ...
        <table id="TABLE1" border="0" cellpadding="1" cellspacing="0" style="width: 100%">
            <tr style="display: none">
                <td align="left" colspan="2" class="head1">
                    ...
                    <asp:TextBox ID="deptid" runat="server" Visible="False" Width="33px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                    ...
                    <table id="TABLE2" border="0" cellpadding="1" cellspacing="0" style="width: 100%">
                        <tr>
                            ...
                            <td width="70%" align="right">
                                <a href="/backoffice/department/viewdepartment.aspx" style="color: White"><b>Back To
                                    Department</b></a> &nbsp;
                            </td>
                        </tr>
                    </table>
            ...
            <tr style="display:none">
                <td align="right" style="width: 15%">
                    ASPX Page<span class="star">*</span> :&nbsp;
                </td>
                <td align="left" style="width: 85%">
                    <asp:DropDownList ID="aspxpage" runat="server" Width="602px">
                       
                        <asp:ListItem Value="facultydept.aspx">Faculty Page</asp:ListItem>
                        <asp:ListItem Value="testimonialsdept.aspx">Testimonial Page</asp:ListItem>
                        <asp:ListItem Value="newsdept.aspx">News Page</asp:ListItem>
                        <asp:ListItem Value="eventsdept.aspx">Event Page</asp:ListItem>
                        <asp:ListItem Value="gallerydept.aspx">Gallery Page</asp:ListItem>
                        <asp:ListItem Value="press-release-dept.aspx">Press Release Page</asp:ListItem>
                        <asp:ListItem Value="media-coverage-dept.aspx">Media Coverage Page</asp:ListItem>
                        <asp:ListItem Value="dcpage.aspx" Selected="True">Other Page</asp:ListItem>
                       
                    </asp:DropDownList>
                      <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="aspxpage"
                ...
                <td align="left" valign="top">
                    <asp:CheckBoxList ID="linkpositionstatus" runat="server" RepeatDirection="Horizontal"
                        ...
                        <asp:ListItem>Header</asp:ListItem>
                         <asp:ListItem>Depthappening</asp:ListItem>
                        <%--<asp:ListItem>Left Side Menu</asp:ListItem>
            ...
            <tr>
                ...
                <td align="left">
                    <asp:TextBox ID="displayorder" runat="server" Width="60px"></asp:TextBox>
            ...
            <tr>
                ...
                <td align="left">
                    ...
                    <asp:TextBox ID="pageurl" runat="server" Visible="true" Width="400px"></asp:TextBox>
            ...
            <tr style="display: none;">
                ...
                <td align="left">
                    <asp:CheckBox ID="Pagestatus" runat="server" />
                </td>
            </tr>
            <tr style="display: none;">
                <td align="right">
                ...
                <td align="left">
                    <asp:CheckBox ID="quicklinks" runat="server" />
                </td>
            </tr>
            <tr style="display: none;">
