                        ...
                        <table border="0" cellpadding="2" cellspacing="0" class="panelbg" style="width: 100%">
                            ...
                            <tr>
                                ...
                                <td width="30%" valign="top">
                                    <asp:TextBox ID="UserPassword" runat="server" Width="250px" TextMode="Password"></asp:TextBox>
                            ...
                            <td colspan="4" align="right">
                             <asp:RegularExpressionValidator
                                        ID="RegularExpressionValidator1" runat="server" ControlToValidate="UserPassword" Display="Dynamic"
                                        ErrorMessage="Password must be between 8 and 20 characters and contain one uppercase letter, one lowercase letter, one digit and one special character." ValidationExpression="^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[^\da-zA-Z]).{8,20}$"></asp:RegularExpressionValidator>
                            </td>
                            </tr>
