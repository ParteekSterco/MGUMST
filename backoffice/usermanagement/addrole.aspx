                                        ...
                                        <td>
                                            <table width="100%" border="0" align="left">
                                                ...
                                                <tr >
                                                 ...
                                                 <tr >
                                                    <td style="width: 98%" id="tablenewdept" align="left">
                                                        <asp:GridView ID="grdNewDepartment" runat="server" OnRowDataBound="grdNewDepartment_RowDataBound"
                                                            AutoGenerateColumns="False" CellPadding="4" GridLines="Horizontal" Width="100%">
                                                            <HeaderStyle CssClass="head4" HorizontalAlign="Left" />
                                                            <RowStyle CssClass="grid" />
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField Visible="false">
                                                                    <HeaderStyle HorizontalAlign="Center" />
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lbldeptid" runat="server" Text='<%#Eval("deptid") %>' Visible="false"></asp:Label><br />
                                                                    </ItemTemplate>
                                                                    <ItemStyle HorizontalAlign="Center" />
                                                                    <ItemStyle HorizontalAlign="Center" />
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="Department" ItemStyle-Width="20%">
                                                                    <HeaderStyle HorizontalAlign="Center" />
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblSubDepartment" runat="server" Text='<%#Eval("deptname") %>'></asp:Label><br />
                                                                    </ItemTemplate>
                                                                    <ItemStyle HorizontalAlign="Center" />
                                                                    <ItemStyle HorizontalAlign="Center" />
                                                                </asp:TemplateField>
                                                                  <asp:TemplateField HeaderText="College" ItemStyle-Width="20%">
                                                                    <HeaderStyle HorizontalAlign="Center" />
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblcollegename" runat="server" Text='<%#Eval("collagename") %>'></asp:Label><br />
                                                                    </ItemTemplate>
                                                                    <ItemStyle HorizontalAlign="Center" />
                                                                    <ItemStyle HorizontalAlign="Center" />
                                                                </asp:TemplateField>
