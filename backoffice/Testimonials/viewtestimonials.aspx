                ...
                <asp:Panel ID="Panel1" runat="server" DefaultButton="btnSearch" GroupingText="Search"
                    ...
                    <table id="Table3" border="0" cellpadding="2" cellspacing="0" class="panelbg" width="100%">
                        ...
                        <tr>
                            ...
                            <td align="left">
                                <asp:TextBox ID="TextBox4" runat="server" CssClass="box" Width="280px"></asp:TextBox>
                            </td>
                            <td align="right">
                                Testimonial Type
                            </td>
                            <td align="left">
                                <asp:DropDownList ID="Tesid" runat="server" CssClass="box" Width="280px">
                                </asp:DropDownList>
                            </td>
                             </tr>
                        <tr>
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Show Home">
                          ...
                          <asp:TemplateField HeaderText="Map Campus" Visible="false">
                            ...
                            <ItemStyle HorizontalAlign="Center" />
                            <ItemTemplate>
                                <asp:Literal Text='<%# Eval("testimonialid")%>' ID="litcid1" Visible="false" runat="server" />
                                <asp:Panel runat="server" ID="pnl_research1" Visible="true">
                                    <a class="toptxttestimonial" visible="false"
                                        href='maptestimonialscampus.aspx?testimonialid=<%#Eval("testimonialid")%>'>
