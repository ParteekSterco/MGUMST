...
<div class="content-panel">
    <table id="TABLE1" border="0" cellpadding="1" cellspacing="0" style="width: 100%">
        ...
        <tr>
         ...
         <tr>
            <td align="right" style="width: 15%; height: 26px;">
                Second Name<span class="star"></span> :&nbsp;
            </td>
            <td align="left" style="width: 85%; height: 26px;">
                <asp:TextBox ID="secondname" runat="server" CssClass="box" MaxLength="100" TabIndex="3"
                    Width="214px"></asp:TextBox>
        ...
        <tr>
         ...
         <tr style="display: none">
            ...
            <td align="left">
                <asp:TextBox ID="rewriteurl" runat="server" Width="200px"></asp:TextBox>
            </td>
        </tr>
...
OnRowCommand="GridView1_RowCommand" OnRowDataBound="GridView1_RowDataBound">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Delete" Visible="false">
                                     ...
                                     <asp:TemplateField HeaderText="SEO College"  >
                            <HeaderStyle HorizontalAlign="Center" Width="10%" />
                            <ItemStyle HorizontalAlign="Center" />
                            <ItemTemplate>
                          <a class="toptxtseo" href='testimonialtype_colllageseo.aspx?Tesid=<%#(Eval("Tesid"))%>'>
                                    <img src="../assets/Preview_24x24.png" border="0"></a>
                       
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="SEO Department"  >
                            <HeaderStyle HorizontalAlign="Center" Width="10%" />
                            <ItemStyle HorizontalAlign="Center" />
                            <ItemTemplate>
                          <a class="toptxtseo" href='testimonialtype_deptseo.aspx?Tesid=<%#(Eval("Tesid"))%>'>
                                    <img src="../assets/Preview_24x24.png" border="0"></a>
