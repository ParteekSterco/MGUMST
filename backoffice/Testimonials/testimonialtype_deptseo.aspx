<%@ Page Language="C#" AutoEventWireup="true" CodeFile="testimonialtype_deptseo.aspx.cs" Inherits="backoffice_Testimonials_testimonialtype_deptseo" Theme="backtheme" %>
            ...
            <tr>
              ...
              <tr>
                        <td valign="top" width="15%" align="right">
                            College<span class="star">*</span> : &nbsp;</td>
                        <td width="85%">
                            <asp:DropDownList ID="collageid" runat="server" Width="500" 
                                onselectedindexchanged="collageid_SelectedIndexChanged" AutoPostBack="true">
                            </asp:DropDownList>
                   ...
                   <tr>
                        <td valign="top" width="15%" align="right">
                            Department<span class="star">*</span> : &nbsp;</td>
                        <td width="85%">
                            <asp:DropDownList ID="deptid" runat="server" Width="500">
                            </asp:DropDownList>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" InitialValue="0" runat="server" ControlToValidate="deptid"
                                Display="Dynamic" ErrorMessage="Required" ></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Publish">
                            <ItemTemplate>
                               <asp:TextBox ID="txtstatus" runat="server" Text='<%#Eval("status")%>' Visible="false"></asp:TextBox>
                                <asp:ImageButton ID="lnkstatus" runat="server" CausesValidation="false" CommandArgument='<%# Eval("id") %>'
                        ...
                        <asp:TemplateField HeaderText="Edit">
                          ...
                          <asp:TemplateField HeaderText="Delete" >
                            ...
                            <ItemStyle HorizontalAlign="Center" />
                            <ItemTemplate>
                                <asp:ImageButton ID="btndel" runat="server" CausesValidation="false" CommandArgument='<%#Eval("id")%>'
