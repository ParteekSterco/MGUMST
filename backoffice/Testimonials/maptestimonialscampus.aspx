<%@ Page Language="C#" AutoEventWireup="true" CodeFile="maptestimonialscampus.aspx.cs" Theme="backtheme" Inherits="backoffice_Testimonials_maptestimonialscampus" %>
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                            <tr>
                                                <td width="90%" align="left">
                                                    ...
                                                    <asp:Label ID="lblcampusname" runat="server" Text='<%#Eval("campus_name")%>'
