<%@ Page Title="" Language="C#" MasterPageFile="~/backoffice/layouts/BackMaster.master"  AutoEventWireup="true" Theme="backtheme" CodeFile="viewconvocation.aspx.cs" Inherits="backoffice_convocation_viewconvocation" %>
                                ...
                                <table id="Table3" border="0" cellpadding="2" cellspacing="0" class="panelbg" width="100%">
                                    ...
                                    <tr>
                                        <td align="center" colspan="4">
                                            &nbsp;
                                              Title:  <asp:TextBox ID="title" runat="server" Width="359px"></asp:TextBox>
                                        </td>
                                                                                <td align="left">
                        ...
                        <asp:TemplateField HeaderText="Status">
                           ...
                           <asp:TemplateField HeaderText="Show on Home" Visible="false">
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <asp:ImageButton ID="lnkstatus1" runat="server" CausesValidation="false" CommandArgument='<%#Eval("cid")%>'
                                ...
                                <asp:TemplateField HeaderText="Show on micro site" Visible="false">
                                    ...
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtshowonmicrosite" runat="server" Text='<%#Eval("showonmicrosite")%>'
                                            Visible="false"></asp:TextBox>
                                        <asp:ImageButton ID="lnkstatus2" runat="server" CausesValidation="false" CommandArgument='<%#Eval("cid")%>'
                                ...
                                <asp:TemplateField HeaderText="Add Pic">
                                    ...
                                    CommandArgument='<%#Eval("cid") %>'><img border="0" src="../images/view.gif" alt="" /></asp:LinkButton>
                                <a  class="various" style="color:Black" visible="false"
                                    href='upload_photo.aspx?cid=<%#Eval("cid") %>'>
                                    Add Edit pic
                                    </ItemTemplate>
                                </asp:TemplateField>
