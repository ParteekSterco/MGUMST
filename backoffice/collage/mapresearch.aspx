<%@ Page Title="" Language="C#" MasterPageFile="~/backoffice/layouts/BackMaster.master"  AutoEventWireup="true" CodeFile="mapresearch.aspx.cs" Inherits="backoffice_collage_mapresearch" Theme="backtheme" %>
                    ...
                    <asp:Panel ID="Panel1" runat="server" GroupingText="Map Research" CssClass="mapping"
                        ...
                        <table id="Table3" border="0" cellpadding="2" cellspacing="0" width="100%">
                           <tr width="100%">
                                ...
                                <td align="right">
                                    Department:<asp:DropDownList ID="drpdept" runat="server" AutoPostBack="True" Width="400px"
                                                 ...
                                                 <td>
                                                   <%# Container.ItemIndex + 1%>. 
                                                    ...
                                                    <td class="faculty-name">
                                                        <asp:Label ID="lblcname" runat="server" Text='<%# Eval("researchTitle") %>' Visible="true"></asp:Label>
