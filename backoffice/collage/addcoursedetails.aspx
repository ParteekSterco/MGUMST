<%@ Page Title="" Language="C#" MasterPageFile="~/backoffice/layouts/BackMaster.master" Theme="backtheme" AutoEventWireup="true" CodeFile="addcoursedetails.aspx.cs" Inherits="backoffice_collage_addcoursedetails" %>
    ...
    <div class="content-panel">
        ...
        <tr >
            <td align="left" colspan="2" class="head1">
                <asp:TextBox ID="csid" runat="server" Visible="false" Width="33px"></asp:TextBox>
                <asp:TextBox ID="collegeid" runat="server" Visible="false" Width="33px"></asp:TextBox>
            </td>
        </tr>
            <tr>
    ...
    <td colspan="2">
        <table id="TABLE2" border="0" cellpadding="1" cellspacing="0" style="width: 100%">
            ...
            <tr >
                ...
                <td width="85%">
                    <asp:DropDownList ID="courseid" runat="server" Width="350px" ></asp:DropDownList>
                   <asp:RequiredFieldValidator ID="RequiredFieldValidator13" runat="server" ControlToValidate="courseid"
                        Display="Dynamic" ErrorMessage="Required" InitialValue="0"></asp:RequiredFieldValidator>
                </td>
            </tr>
            ...
            <tr style="display:none">
                <td valign="top" width="15%" align="right">
                    Programme Level<span class="star">*</span> : &nbsp;
                </td>
                <td width="85%">
            ...
            <tr style="display:none">
                <td valign="top" align="right">
                    Second Course Name<span class="star"></span> : &nbsp;
                </td>
                <td>
            ...
            <tr style="display:none;">
                <td valign="top" align="right">
                    Applying for Admissions<span class="star"></span> : &nbsp;
                </td>
                <td>
            ...
            <tr>
                ...
                <td align="left">
                    ...
                    <asp:LinkButton ID="LinkButton2" runat="server" OnClick="LinkButton2_Click" CssClass="toptxt"
                        Visible="false">Remove  Course Brochure</asp:LinkButton>
            ...
            <%-- <% if (Convert.ToString(Session["Trid"])=="6")
       { %>--%>
            <tr style="display: none;" >
                <td valign="top" align="right">
                    Group Rewrite Url
