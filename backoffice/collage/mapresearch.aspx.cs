    ...
    void map_cat_product()
    {
        foreach (DataListItem row1 in dl_sgroup.Items)
        {
            ...
            if ((checkfeature.Checked == true))
            {
                ...
                {
                    Parameters.Clear();
                    if (clsm.Checking_Parameter("select mid from map_institute_research where collageid="
                    ...
                    {
                        Parameters.Clear();
                        clsm.ExecuteQry_Parameter("insert into map_institute_research (collageid,researchid,deptid,displayorder) values("
                    ...
                    {
                        Parameters.Clear();
                        clsm.ExecuteQry_Parameter("update  map_institute_research  set  displayorder=" + txtdisplayorder.Text + " where collageid=" + (Conversion.Val(Request.QueryString["clid"])) + " and researchid=" + Conversion.Val(lblEventsid.Text) + " and deptid=" + Conversion.Val(drpdept.SelectedValue) + "", Parameters);
                ...
                {
                    Parameters.Clear();
                    clsm.ExecuteQry_Parameter("update  map_institute_research  set  showonhome=1 where collageid=" + (Conversion.Val(Request.QueryString["clid"])) + " and researchid=" + Conversion.Val(lblEventsid.Text) + " and deptid=" + Conversion.Val(drpdept.SelectedValue) + "", Parameters);
                }
                else
                {
                    Parameters.Clear();
                    clsm.ExecuteQry_Parameter("update  map_institute_research  set  showonhome=0 where collageid=" + (Conversion.Val(Request.QueryString["clid"])) + " and researchid=" + Conversion.Val(lblEventsid.Text) + " and deptid=" + Conversion.Val(drpdept.SelectedValue) + "", Parameters);
                }
            ...
            {
                Parameters.Clear();
                clsm.ExecuteQry_Parameter("delete from  map_institute_research where  collageid=" + Conversion.Val(Request.QueryString["clid"]) + " and researchid=" + Conversion.Val(lblEventsid.Text) + "  and deptid=" + Conversion.Val(drpdept.SelectedValue) + "  ", Parameters);
