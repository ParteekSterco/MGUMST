<%@ Page Title="" Language="C#" MasterPageFile="~/backoffice/layouts/BackMaster.master" AutoEventWireup="true" CodeFile="collage_recruiter.aspx.cs" Inherits="backoffice_collage_collage_recruiter" Theme="backtheme" %>
          ...
          <table id="TABLE1" border="0" cellpadding="1" cellspacing="0" style="width: 100%">
            ...
            <tr>
                <td colspan="2" align="center" width="100%">
                    <asp:Panel ID="Panel2" runat="server" CssClass="mapping" GroupingText="Map Recruiter"
                                                 ...
                                                 <td>
                                                   <%# Container.ItemIndex + 1%>. 
                                                    ...
                                                    <td class="faculty-name">
                                                        <asp:Label ID="lblcname" runat="server" Text='<%#Eval("imgtitle") %>' Visible="true"></asp:Label>
                                                        <asp:Label ID="lbltestimonialid" runat="server" Text='<%#(Eval("imgid")) %>'
                                                      ...
                                                      <asp:Label ID="lblcollage" runat="server"></asp:Label>
                                                       ...
                                                       <td>
                                     <asp:TextBox ID="txtfacultyImage" Visible="false" runat="server" Text='<%#Eval("uploadimage")%>'
                                 ></asp:TextBox>
