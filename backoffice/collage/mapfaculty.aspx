<%@ Page Title="" Language="C#" MasterPageFile="~/backoffice/layouts/BackMaster.master"
    AutoEventWireup="true" CodeFile="mapfaculty.aspx.cs"  Inherits="backoffice_collage_mapfaculty"
    Theme="backtheme" %>
        ...
        <table id="TABLE1" border="0" cellpadding="1" cellspacing="0" style="width: 100%">
                    ...
                    <asp:Panel ID="Panel2" runat="server" DefaultButton="btnSearch" GroupingText="Search"
                        ...
                        <table id="Table4" border="0" cellpadding="2" cellspacing="0" class="panelbg" width="100%">
                            ...
                            <tr>
                                ...
                                <td align="left">
                                    <asp:DropDownList ID="facultyid" runat="server" AutoPostBack="True" Width="400px">
                                    </asp:DropDownList>
                                </td>
                                <td align="right">
                                    &nbsp;Title
                                ...
                                <td align="left">
                                    <asp:TextBox ID="TextBox4" runat="server" CssClass="box" Width="300px"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
            ...
            <tr>
                <td colspan="2" align="center" width="100%">
                    <asp:Panel ID="Panel1" runat="server" GroupingText="Map Faculty" CssClass="mapping"
                        ...
                        <table id="Table3" border="0" cellpadding="2" cellspacing="0" width="100%">
                            <tr width="100%">
                                ...
                                <td align="right">
                                 Map Department:<asp:DropDownList ID="drpdept" runat="server" AutoPostBack="True" Width="400px"
                                ...
                                <td align="left" colspan="2">
                                                   ...
                                                   <%# Container.ItemIndex + 1%>. 
                                                    ...
                                                    <td class="faculty-name" width="10%">
                                                      <asp:Label ID="lblfname" runat="server" Text='<%# Eval("fname") %>' Visible="true"></asp:Label>
                                                        <asp:Label ID="lblfacultyid" runat="server" Text='<%#(Eval("facultyid")) %>' Visible="false"></asp:Label>
                                                    </td>
                                                    <td width="10%">
                                 ...
                                 ></asp:TextBox>
                                         <img id="imagefaculty" runat="server"  width="50"  height="50" />
                                                    ...
                                                    <td  width="30%">
                                                        <asp:TextBox ID="txtdisplayorder" runat="server" Width="70px" Visible="true"></asp:TextBox>
