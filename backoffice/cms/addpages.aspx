...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="content-panel">
        <table id="TABLE1" border="0" cellpadding="1" cellspacing="0" style="width: 100%">
            ...
            <tr bgcolor="#6E83BA" id="tr1" runat="server" visible="false">
                <td colspan="2">
                    <table id="TABLE2" border="0" cellpadding="1" cellspacing="0" style="width: 100%">
                        <tr>
                            <td style="color: #ffffff; font-size: larger; font-weight: bolder; height: 30px; padding-left: 10px;"
                                width="30%">
            ...
            <tr>
                <td align="right" style="width: 15%">Parent Page :</td>
                <td align="left" style="width: 85%">
                    <asp:DropDownList ID="parentid" runat="server" Width="602px">
                    </asp:DropDownList></td>
            </tr>
            <tr>
                <td align="right" style="width: 15%">Page Name<span class="star">*</span> :&nbsp;
                </td>
                <td align="left" style="width: 85%">
            ...
            <tr>
                <td align="right">Link Name<span class="star">*</span> :&nbsp;
                </td>
                <td align="left">
            ...
            <tr>
                <td align="right" valign="top">Tag Line<span class="star"></span> :&nbsp;
                </td>
            ...
            <tr>
                <%--style="display:none"--%>
                <td align="right" valign="top">Page Position :&nbsp;</td>
                <td align="left" valign="top">
                    <asp:CheckBoxList ID="linkpositionstatus" runat="server" RepeatDirection="Horizontal"
                        ...
                        <asp:ListItem>Panel 4</asp:ListItem>
                        <asp:ListItem>Panel 5</asp:ListItem>
            ...
            <tr>
                <td align="right" valign="top">Mega Menu :&nbsp;
                    <br />
            ...
            <tr>
                <td align="right" valign="top">Short Description :&nbsp;
                <br />
                    <span style="font-style: italic; color: red;">(required wherever applicable)</span>
                </td>
                <td align="left">
            ...
            <tr>
                <td align="right" valign="top">Page Description :&nbsp;
                    <br />
                    <span style="font-style: italic; color: red;">(required wherever applicable)</span>
                </td>
                <td align="left">
            ...
            <tr>
                <td align="right" valign="top">Page Description1 :&nbsp;
                   <br />
                    <span style="font-style: italic; color: red;">(required wherever applicable)</span>
                </td>
                <td align="left">
            ...
            <tr>
                <td align="right" valign="top">Page Description2 :&nbsp;
                   <br />
                    <span style="font-style: italic; color: red;">(required wherever applicable)</span>
                </td>
                <td align="left">
            ...
            <tr>
                ...
                <td align="left">
                    ...
                    <asp:TextBox ID="uploadfile" runat="server" Visible="False"></asp:TextBox></td>
            </tr>
            <tr>
                <td align="right">Display Order :&nbsp;
                </td>
                <td align="left">
                    <asp:TextBox ID="displayorder" runat="server" Width="55px" MaxLength="5"></asp:TextBox>
            ...
            <tr>
                <td class="head1" colspan="2" style="font-size: small;" nowrap>SEO Information</td>
            </tr>
            <tr style="display: none">
            ...
            <tr>
                <td align="right" valign="top">Page Script :</td>
                <td align="left" valign="top">
            ...
            <tr style="display: none">
                <td align="right" valign="top">Target :</td>
                <td align="left" valign="top">
