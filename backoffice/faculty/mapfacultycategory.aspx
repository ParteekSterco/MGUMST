<%@ Page Language="C#" AutoEventWireup="true" CodeFile="mapfacultycategory.aspx.cs" Theme="backtheme" Inherits="backoffice_faculty_mapfacultycategory" %>
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                            <tr>
                                                <td width="90%" align="left">
                                                    ...
                                                    <asp:Label ID="lblfaculitycate" runat="server" Text='<%#Eval("facultycate")%>'
