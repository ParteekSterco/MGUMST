<%@ Page Title="" Language="C#" MasterPageFile="~/backoffice/layouts/BackMaster.master" ValidateRequest="false" Theme="backtheme" AutoEventWireup="true" CodeFile="addfacultytype.aspx.cs" Inherits="backoffice_faculty_addfacultytype" %>
...
<table id="TABLE1" border="0" cellpadding="1" cellspacing="0" style="width: 100%">
            ...
            <td align="left" colspan="2">
                <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                    <tr>
                        ...
                        <td align="right" >
                            &nbsp;
                            <asp:TextBox ID="fid" runat="server" Visible="False" Width="33px"></asp:TextBox>
        ...
        <tr>
            <td align="right" style="width: 15%; height: 26px;">
                Faculty Type  <span class="star">*</span> :&nbsp;
            </td>
            <td align="left" style="width: 85%; height: 26px;">
                <asp:TextBox ID="facultytype" runat="server" CssClass="box" MaxLength="100" TabIndex="3"
                    Width="214px"></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="facultytype"
