<%@ Page Title="" Language="C#" MasterPageFile="~/backoffice/layouts/BackMaster.master" ValidateRequest="false" AutoEventWireup="true" CodeFile="addfacultydesignation.aspx.cs" Inherits="backoffice_faculty_addfacultydesignation" Theme="backtheme" %>
...
<table id="TABLE1" border="0" cellpadding="1" cellspacing="0" style="width: 100%">
            ...
            <td align="left" colspan="2">
                <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                    <tr>
                        ...
                        <td align="right" >
                            &nbsp;
                            <asp:TextBox ID="fdid" runat="server" Visible="False" Width="33px"></asp:TextBox>
        ...
        <tr>
            ...
            <td align="left" style="width: 85%; height: 26px;">
                <asp:TextBox ID="designation" runat="server" CssClass="box" MaxLength="100" TabIndex="3"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="S.No.">
                            ...
                            <ItemTemplate>
                               ...
                               <asp:Label ID="Label1" runat="server" Text='<%#(Eval("fdid")) %>' Visible="false"></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Publish">
                            ...
                            <asp:TextBox ID="txtstatus" runat="server" Text='<%#Eval("status") %>' Visible="false"></asp:TextBox>
                                <asp:ImageButton ID="lnkstatus" CssClass="toptxt" runat="server" CausesValidation="false"
                                    CommandArgument='<%#(Eval("fdid")) %>' CommandName="status"></asp:ImageButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Edit">
                            ...
                            <ItemStyle HorizontalAlign="Center" />
                            <ItemTemplate>
                                <asp:ImageButton ID="btnedit" runat="server" CausesValidation="false" CommandArgument='<%#(Eval("fdid")) %>'
                        ...
                        <asp:TemplateField HeaderText="Delete" Visible="false">
                            ...
                            <ItemStyle HorizontalAlign="Center" />
                            <ItemTemplate>
                                <asp:ImageButton ID="btndel" runat="server" CausesValidation="false" CommandArgument='<%#(Eval("fdid")) %>'
