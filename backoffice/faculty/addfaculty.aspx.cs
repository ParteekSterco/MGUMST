...
public partial class backoffice_faculty_addfaculty : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, System.EventArgs e)
    {
        ...
        if ((Page.IsPostBack == false))
        {
            ...
            if ((Conversion.Val(Request.QueryString["fid"]) != 0))
            {
                ...
                Parameters.Clear();
                Parameters.Add("@facultyid", double.Parse(Request.QueryString["fid"]));
                clsm.MoveRecord_Parameter(this, facultyid.Parent, "select * from Addfacultymaster where facultyid=@facultyid", Parameters);
                ...
                if ((fimage.Text != ""))
                {
                    ...
                    Image1.ImageUrl = ("~/Uploads/faculty/" + fimage.Text);
                }
                ...
                if ((limage.Text != ""))
                {
                    ...
                    Image2.ImageUrl = ("~/Uploads/faculty/" + limage.Text);
                }
    ...
    {
        Parameters.Clear();
        clsm.Fillcombo_Parameter("SELECT designation,fdid FROM Facultydesignation where status=1 order by displayorder", Parameters, Designation);
    }
    ...
    {
        Parameters.Clear();
        clsm.Fillcombo_Parameter("SELECT facultytype,fid FROM Facultytype where status=1 order by displayorder", Parameters, fid);
    }
    ...
    protected void btnsubmit_Click(object sender, System.EventArgs e)
    {
        try
        {
            ...
            if ((Conversion.Val(facultyid.Text) == 0))
            {
                ...
                CKeditor17.ReadOnly = true;
                CKeditor18.ReadOnly = true;
                object var = clsm.MasterSave(this, facultyid.Parent, 52, mainclass.Mode.modeAdd, "addfacultymasterSP", Convert.ToString(Session["UserId"]));
                CKeditor1.ReadOnly = false;
                CKeditor2.ReadOnly = false;
                CKeditor3.ReadOnly = false;
                CKeditor4.ReadOnly = false;
                ...
                clsm.AddLogHistory(Convert.ToString(Request.Url), Convert.ToString(0), "Add", Convert.ToString(fname.Text), Convert.ToString(var), Convert.ToString("Faculty"), Convert.ToString(Conversion.Val(Request.QueryString["clid"])), "Faculty");
                ...
                {
                    Parameters.Clear();
                    Parameters.Add("@facultyid", Conversion.Val(var));
                    string strhomeimg = Convert.ToString(clsm.SendValue_Parameter("Select fimage from Addfacultymaster where facultyid=@facultyid", Parameters));
                    FileInfo F1 = new FileInfo((Request.ServerVariables["Appl_Physical_Path"] + "Uploads\\faculty\\" + strhomeimg));
                    if (F1.Exists)
                    {
                        F1.Delete();
                    }

                    File1.PostedFile.SaveAs((Request.ServerVariables["Appl_Physical_Path"] + ("\\uploads\\faculty\\" + strhomeimg)));
                }
                ...
                if ((File2.PostedFile.FileName != ""))
                {
                    Parameters.Clear();
                    Parameters.Add("@facultyid", Conversion.Val(var));
                    string strhomeimg1 = Convert.ToString(clsm.SendValue_Parameter("Select limage from Addfacultymaster where facultyid=@facultyid", Parameters));
                    FileInfo F1 = new FileInfo((Request.ServerVariables["Appl_Physical_Path"] + "Uploads\\faculty\\" + strhomeimg1));
                    if (F1.Exists)
                    {
                        F1.Delete();
                    }

                    File2.PostedFile.SaveAs((Request.ServerVariables["Appl_Physical_Path"] + "\\uploads\\faculty\\" + strhomeimg1));
                }

                clsm.ClearallPanel(this, facultyid.Parent);
                CKeditor2.Text = "";
            ...
            else
            {
                ...
                CKeditor17.ReadOnly = true;
                CKeditor18.ReadOnly = true;
                object var = clsm.MasterSave(this, facultyid.Parent, 52, mainclass.Mode.modeModify, "addfacultymasterSP", Convert.ToString(Session["UserId"]));
                CKeditor1.ReadOnly = false;
                CKeditor2.ReadOnly = false;
                CKeditor3.ReadOnly = false;
                CKeditor4.ReadOnly = false;
                ...
                clsm.AddLogHistory(Convert.ToString(Request.Url), Convert.ToString(0), "Edit", Convert.ToString(fname.Text), Convert.ToString(var), Convert.ToString("Faculty"), Convert.ToString(Conversion.Val(Request.QueryString["clid"])), "Faculty");
                ...
                if ((File1.PostedFile.FileName != ""))
                {
                    FileInfo F5 = new FileInfo((Request.ServerVariables["Appl_Physical_Path"] + "Uploads\\faculty\\" + fimage.Text));
                    if (F5.Exists)
                    {
                        F5.Delete();
                    }
                    ...
                    FileInfo F2 = new FileInfo((Request.ServerVariables["Appl_Physical_Path"] + "Uploads\\faculty\\" + fimage.Text));
                    if (F2.Exists)
                    {
                        F2.Delete();
                    }
                    ...
                    objcon2.Open();
                    SqlCommand objcmd2 = new SqlCommand(("update Addfacultymaster set fimage=@fimage where facultyid=" + (Conversion.Val(var) + "")), objcon2);
                    objcmd2.Parameters.Add(new SqlParameter("@fimage", fimage.Text));
                    objcmd2.ExecuteNonQuery();
                    objcon2.Close();
                    File1.PostedFile.SaveAs((Request.ServerVariables["Appl_Physical_Path"] + "\\uploads\\faculty\\" + fimage.Text));
                }

                if ((File2.PostedFile.FileName != ""))
                {
                    FileInfo F5 = new FileInfo((Request.ServerVariables["Appl_Physical_Path"] + "Uploads\\faculty\\" + limage.Text));
                    if (F5.Exists)
                    {
                        F5.Delete();
                    }
                    ...
                    FileInfo F2 = new FileInfo((Request.ServerVariables["Appl_Physical_Path"] + "Uploads\\faculty\\" + limage.Text));
                    if (F2.Exists)
                    {
                        F2.Delete();
                    }
                    ...
                    SqlConnection objcon2 = new SqlConnection(clsm.strconnect);
                    objcon2.Open();
                    SqlCommand objcmd2 = new SqlCommand(("update Addfacultymaster set limage=@limage where facultyid="
                                    + (Conversion.Val(var) + "")), objcon2);
                    objcmd2.Parameters.Add(new SqlParameter("@limage", limage.Text));
                    objcmd2.ExecuteNonQuery();
                    objcon2.Close();
                    File2.PostedFile.SaveAs((Request.ServerVariables["Appl_Physical_Path"] + "\\uploads\\faculty\\" + limage.Text));
                }

                Response.Redirect("viewfaculty.aspx?edit=edit");
            }
    ...
    {
        if ((double.Parse(facultyid.Text) == 0))
        {
            clsm.ClearallPanel(this, facultyid.Parent);
        }
        else
    ...
    {
        Parameters.Clear();
        Parameters.Add("@facultyid", double.Parse(facultyid.Text));
        clsm.ExecuteQry_Parameter("update Addfacultymaster set fimage='' where facultyid=@facultyid", Parameters);
        FileInfo F1 = new FileInfo((Request.ServerVariables["Appl_Physical_Path"] + ("Uploads\\faculty\\" + fimage.Text)));
        fimage.Text = "";
        if (F1.Exists)
        {
            F1.Delete();
    ...
    protected void LinkButton1_Click(object sender, System.EventArgs e)
    {
        Parameters.Clear();
        Parameters.Add("@facultyid", double.Parse(facultyid.Text));
        clsm.ExecuteQry_Parameter("update Addfacultymaster set limage='' where facultyid=@facultyid", Parameters);
        FileInfo F1 = new FileInfo((Request.ServerVariables["Appl_Physical_Path"] + ("Uploads\\faculty\\" + limage.Text)));
        limage.Text = "";
        if (F1.Exists)
        {
            F1.Delete();
