<%@ Page Title="" Language="C#" MasterPageFile="~/backoffice/layouts/BackMaster.master" ValidateRequest="false" Theme="backtheme" AutoEventWireup="true" CodeFile="addfaculty.aspx.cs" Inherits="backoffice_faculty_addfaculty" %>
...
//            dp_cal = new Epoch('epoch_popup', 'popup', document.getElementById('<%=dob.ClientID%>'));
    ...
    <div class="content-panel">
        <table id="TABLE1" border="0" cellpadding="1" cellspacing="0" style="width: 100%">
                ...
                <td align="left" colspan="2">
                    <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                        <tr>
                            <td class="head1"></td>
                            <td align="right">
                                <asp:TextBox ID="facultyid" runat="server" Width="122px" Visible="false"></asp:TextBox>
                                ...
                                <asp:CheckBox ID="showonhome_campus" runat="server" Visible="False" />
                            </td>
                        </tr>
                    </table>
                </td>
            ...
            <tr>
                <td align="right" colspan="2">Fields with <span style="color: #ff0000">*</span> are mandatory
                </td>
            </tr>
            <tr>
                <td colspan="2">
                    <table border="0" cellpadding="1" cellspacing="0" style="width: 100">
                        <tr style="display: none;">
                            <td align="right" valign="top" width="15%">Faculty Type <%--Academic Designation--%> <span class="star">*</span> : &nbsp;
                            </td>
                            <td width="85%">
                                <asp:DropDownList ID="fid" runat="server" Width="300px">
                        ...
                        <tr>
                            <td valign="top" align="right">Department <span class="star"></span>: &nbsp;
                            </td>
                            <td>
                        ...
                        <tr>
                            <td align="right" valign="top" width="15%">Name Prefix<span class="star">*</span> : &nbsp;
                            </td>
                            <td width="85%">
                        ...
                        <tr>
                            <td align="right" valign="top" width="15%">Faculty Name<span class="star">*</span> : &nbsp;
                            </td>
                            <td width="85%">
                                <asp:TextBox ID="fname" runat="server" Width="300px"></asp:TextBox>
                        ...
                        <tr style="display: none">
                            <td align="right" valign="top" width="15%">Date-Of-Birth<span class="star"></span> : &nbsp;
                            </td>
                            <td>
                    ...
                    Display="Dynamic" ErrorMessage="Required"></asp:RequiredFieldValidator>--%>
                        ...
                        <tr>
                            <td align="right" valign="top" width="15%">Date-Of-Joining<span class="star"></span> : &nbsp;
                            </td>
                            <td>
                    ...
                    Display="Dynamic" ErrorMessage="Required"></asp:RequiredFieldValidator>--%>
                        ...
                        <tr>
                            <td valign="top" align="right">Qualification <span class="star"></span>: &nbsp;
                            </td>
                            <td>
                                <asp:TextBox ID="qualification" runat="server" Width="300px"></asp:TextBox>
                                <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="Designation"
                                Display="Dynamic" ErrorMessage="Required" ValidationGroup="addfaculty"></asp:RequiredFieldValidator>--%>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td valign="top" align="right">Specialization <span class="star"></span>: &nbsp;
                            </td>
                            <td>
                                <asp:TextBox ID="Specialization" runat="server" Width="300px"></asp:TextBox>
                                <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="Designation"
                                Display="Dynamic" ErrorMessage="Required" ValidationGroup="addfaculty"></asp:RequiredFieldValidator>--%>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td valign="top" align="right">Years of Experience <span class="star"></span>: &nbsp;
                            </td>
                            <td>
                        ...
                        <tr>
                            <td valign="top" align="right">Email <span class="star"></span>: &nbsp;
                            </td>
                            <td>
                        ...
                        <tr style="display: none">
                            <td valign="top" align="right">Mobile <span class="star"></span>: &nbsp;
                            </td>
                            <td>
                        ...
                        <tr>
                            <td valign="top" align="right">Linked In <span class="star"></span>: &nbsp;
                            </td>
                            <td>
                        ...
                        <tr style="display: none">
                            <td valign="top" align="right">Registration No. : &nbsp;
                            </td>
                            <td>
                        ...
                        <tr style="display: none">
                            <td valign="top" align="right">Email/Social link: &nbsp;
                            </td>
                            <td>
                        ...
                        <tr style="display: none">
                            <td valign="top" align="right">Interest Area(s) : &nbsp;
                            </td>
                            <td>
                        ...
                        <tr>
                            <td valign="top" align="right">Faculty Profile : &nbsp;
                            </td>
                            <td>
                        ...
                        <tr style="display: none">
                            <td valign="top" align="right">Award & Recognition : &nbsp;
                            </td>
                            <td>
                        ...
                        <tr style="display: none">
                            <td valign="top" align="right">Experience : &nbsp;
                            </td>
                            <td>
                        ...
                        <tr style="display: none">
                            <td valign="top" align="right">Subjects Taught: &nbsp;
                            </td>
                            <td>
                        ...
                        <tr style="display: none">
                            <td valign="top" align="right">Research: &nbsp;
                            </td>
                            <td>
                        ...
                        <tr style="display: none">
                            <td valign="top" align="right">International: &nbsp;
                            </td>
                            <td>
                        ...
                        <tr style="display: none">
                            <td valign="top" align="right">Projects Carried out: &nbsp;
                            </td>
                            <td>
                        ...
                        <tr style="display: none">
                            <td valign="top" align="right">Technology Transfer : &nbsp;
                            </td>
                            <td>
                        ...
                        <tr style="display: none">
                            <td valign="top" align="right">Consultancy : &nbsp;
                            </td>
                            <td>
                        ...
                        <tr style="display: none">
                            <td valign="top" align="right">Grant : &nbsp;
                            </td>
                            <td>
                        ...
                        <tr style="display: none">
                            <td valign="top" align="right">Membership: &nbsp;
                            </td>
                            <td>
                        ...
                        <tr style="display: none">
                            <td valign="top" align="right">Industrial Training: &nbsp;
                            </td>
                            <td>
                        ...
                        <tr style="display: none">
                            <td valign="top" align="right">Any other Achievements: &nbsp;
                            </td>
                            <td>
                        ...
                        <tr style="display: none">
                            <td valign="top" align="right">Projects/Achievements : &nbsp;
                            </td>
                            <td>
                        ...
                        <tr style="display: none">
                            <td valign="top" align="right">Publications: &nbsp;
                            </td>
                            <td>
                        ...
                        <tr style="display: none">
                            <td valign="top" align="right">Certifications : &nbsp;
                            </td>
                            <td>
                        ...
                        <tr>
                            <td valign="top" align="right">Small Image : &nbsp;
                            </td>
                            <td>
                        ...
                        <tr style="display: none">
                            <td valign="top" align="right">Large Image : &nbsp;
                            </td>
                            <td>
                        ...
                        <tr style="display: none">
                            <td valign="top" align="right">Reputed Faculty : &nbsp;
                            </td>
                            <td>
                        ...
                        <tr style="display: none">
                            <td valign="top" align="right">Affiliate Faculty : &nbsp;
                            </td>
                            <td>
                        ...
                        <tr>
                            <td align="right">Displayorder<span class="star"></span> :&nbsp;
                            </td>
                            <td>
                        ...
                        <tr>
                            <td class="head1" colspan="2" style="font-size: small;" nowrap>SEO Information
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td align="right" valign="top">Meta Keywords :
                            </td>
                        ...
                        <tr>
                            <td align="right" valign="top">Meta Description :
                            </td>
                            <td align="left" valign="top">
                        ...
                        <tr>
                            <td align="right" valign="top">Other Schema :
                            </td>
                            <td align="left" valign="top">
                        ...
                        <tr>
                            <td align="right" valign="top">No Index Follow :
                            </td>
                            <td align="left" valign="top">
