...
public partial class backoffice_media_viewmedia_section : System.Web.UI.Page
{
    ...
    public void gridshow()
    {
        string strsql = "";
        parameters.Clear();
        strsql = "select distinct a.*,b.ntype from Events a left join newstype b on a.ntypeid=b.ntypeid left join map_happening_campus mc on a.eventsid=mc.eventsid left join  map_institute_happenings  mf  on  mc.eventsid=mf.eventsid  where 1=1  ";
