...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="content-panel">
        <table id="TABLE1" border="0" cellpadding="1" cellspacing="0" style="width: 100%">
            ...
            <tr>
                <td align="right" style="width: 30%; height: 26px;">Title<span class="star">*</span> :&nbsp;
                </td>
            ...
            <tr style="display: none">
                <td align="right" style="width: 30%; height: 26px;">Url<span class="star">*</span> :&nbsp;
                </td>
                <td align="left" style="width: 70%; height: 26px;">
            ...
            <tr>
                <td align="right" height="10" style="width: 30%"></td>
                ...
                <td align="center" colspan="2">
                    ...
                    <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Single / Multiple">
                                <HeaderStyle HorizontalAlign="Center" Width="10%" />
                                <ItemStyle HorizontalAlign="Center" />
                                <ItemTemplate>
                                    <asp:TextBox ID="txtchklist" runat="server" Text='<%# Eval("chklist") %>' Visible="false"></asp:TextBox>
                                    <asp:TextBox ID="txtntypeid" runat="server" Text='<%# Eval("ntypeid") %>' Visible="false"></asp:TextBox>
                                    <asp:ImageButton ID="lnkchklist" CssClass="toptxt" runat="server" CausesValidation="false"
                                        CommandArgument='<%#Eval("ntypeid")%>' CommandName="chklist"></asp:ImageButton>
                                </ItemTemplate>
                            </asp:TemplateField>
