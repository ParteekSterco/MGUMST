<%@ Page Title="" Language="C#" MasterPageFile="~/backoffice/layouts/BackMaster.master" ValidateRequest="false" Theme="backtheme" AutoEventWireup="true" CodeFile="laboratoriescat.aspx.cs" Inherits="backoffice_Laboratories_laboratoriescat" %>
...
<input type="hidden" value="<%=appno%>" name="appno" id="appno">
    ...
    <script type="text/javascript">
      ...
      <h2> Add/Edit Laboratories Category</h2>
...
<table id="TABLE1" border="0" cellpadding="1" cellspacing="0" style="width: 100%">
            ...
            <td align="left" colspan="2">
                <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                    <tr>
                        ...
                        <td align="right" >
                            &nbsp;
                            <asp:TextBox ID="lcid" runat="server" Visible="False" Width="33px"></asp:TextBox>
        ...
        <tr>
            ...
            <td align="left" style="width: 85%; height: 26px;">
                <asp:TextBox ID="labcattitle" runat="server" CssClass="box" MaxLength="100" TabIndex="3"
                    Width="350px"></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="labcattitle"
         ...
         <tr>
            ...
            <td align="left" >
                <asp:TextBox ID="displayorder" runat="server" Width="66px"></asp:TextBox>
                ...
                OnRowCommand="GridView1_RowCommand"   OnRowDataBound="GridView1_RowDataBound"  >
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="S.No.">
                         ...
                         <asp:TemplateField HeaderText="Name Prefix">
                             <HeaderStyle HorizontalAlign="center"  />
                            <ItemStyle HorizontalAlign="center"  />
                            <ItemTemplate>
                                <%#Eval("labcattitle").ToString()%>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Publish">
                            ...
                            <asp:TextBox ID="txtstatus" runat="server" Text='<%#Eval("status") %>' Visible="false"></asp:TextBox>
                                <asp:ImageButton ID="lnkstatus" CssClass="toptxt" runat="server" CausesValidation="false"
                                    CommandArgument='<%#(Eval("lcid")) %>' CommandName="status"></asp:ImageButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Edit">
                            ...
                            <ItemStyle HorizontalAlign="Center" />
                            <ItemTemplate>
                                <asp:ImageButton ID="btnedit" runat="server" CausesValidation="false" CommandArgument='<%#(Eval("lcid")) %>'
                        ...
                        <asp:TemplateField HeaderText="Delete" Visible="false">
                            ...
                            <ItemStyle HorizontalAlign="Center" />
                            <ItemTemplate>
                                <asp:ImageButton ID="btndel" runat="server" CausesValidation="false" CommandArgument='<%#(Eval("lcid")) %>'
