<%@ Page Title="" Language="C#" MasterPageFile="~/backoffice/layouts/BackMaster.master" Theme="backtheme" AutoEventWireup="true" CodeFile="viewstaff.aspx.cs" Inherits="backoffice_staff_viewstaff" %>
                ...
                <asp:Panel ID="Panel1" runat="server" DefaultButton="btnSearch" GroupingText="Search"
                    ...
                    <table id="Table3" border="0" cellpadding="2" cellspacing="0" class="panelbg" width="100%">
                        ...
                        <tr>
                            ...
                            <td align="left">
                                <asp:DropDownList ID="drpfacultytype" runat="server" Width="300px"></asp:DropDownList>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td align="left">
                                <asp:TextBox ID="faculty" runat="server" Width="300px"></asp:TextBox>
                            </td>
                            ...
                            <td align="left">
                                <asp:DropDownList ID="drpdesignation" runat="server" Width="300px"></asp:DropDownList>
                            </td>
                        ...
                        <%--<tr style="display: none">
                            ...
                            <td align="left">
                                <asp:DropDownList ID="ddldepartement" runat="server" Width="200px">
                                </asp:DropDownList>
                            </td>
                ...
                <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Designation">
                            ...
                            <ItemStyle HorizontalAlign="center" Width="10%" />
                            <ItemTemplate>
                                <%#Eval("staffdesignation").ToString()%>
                            </ItemTemplate>
                        </asp:TemplateField>
                       ...
                       <%-- <asp:TemplateField HeaderText="Qualification">
                            ...
                            <ItemTemplate>
                               <%-- <%#Eval("displayorder").ToString()%>--%>
                                <asp:TextBox ID="txtdsiplau" runat="server" Text='<%#Eval("displayorder")%>'></asp:TextBox>
                                 <asp:TextBox ID="txtfacultyid" runat="server" Visible="false" Text='<%#Eval("staffid")%>'></asp:TextBox>
                        ...
                        <asp:TemplateField HeaderText="Publish">
                            ...
                            <ItemTemplate>
                                ...
                                <asp:ImageButton ID="lnkstatus" CssClass="toptxt" runat="server" CausesValidation="false"
                                    CommandArgument='<%#(Eval("staffid")) %>' CommandName="lnkstatus"></asp:ImageButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                    
                        <asp:TemplateField HeaderText="Show With Picture">
                            <HeaderStyle HorizontalAlign="Center" Width="5%" />
                            <ItemStyle HorizontalAlign="Center" />
                            <ItemTemplate>
                                ...
                                <asp:ImageButton ID="lnkshowonhome" CssClass="toptxt" runat="server" CausesValidation="false"
                                    CommandArgument='<%# Eval("staffid") %>' CommandName="lnkshowonhome"></asp:ImageButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Show Details">
                            ...
                            <ItemTemplate>
                                ...
                                <asp:ImageButton ID="lnkReputed" CssClass="toptxt" runat="server" CausesValidation="false"
                                    CommandArgument='<%# Eval("staffid") %>' CommandName="lnkReputed"></asp:ImageButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Edit">
                            ...
                            <ItemStyle HorizontalAlign="Center" />
                            <ItemTemplate>
                                <asp:ImageButton ID="btnedit" runat="server" CausesValidation="false" CommandArgument='<%#(Eval("staffid")) %>'
                                    CommandName="btnedit" ImageUrl="~/backoffice/assets/edit.png" ToolTip="Click to Edit" />
                            </ItemTemplate>
                        </asp:TemplateField>


                            <asp:TemplateField HeaderText="Map Institute"  Visible="true">
                            <HeaderStyle HorizontalAlign="Center" Width="10%" />
                            <ItemStyle HorizontalAlign="Center" />
                            <ItemTemplate>
                          <a class="toptxtinstitutestaff" href='mapinstitutestaff.aspx?staffid=<%#(Eval("staffid"))%>'>
                        ...
                        <asp:TemplateField HeaderText="Delete"  >
                            ...
                            <ItemStyle HorizontalAlign="Center" />
                            <ItemTemplate>
                                <asp:ImageButton ID="btndel" runat="server" CausesValidation="false" CommandArgument='<%#(Eval("staffid")) %>'
