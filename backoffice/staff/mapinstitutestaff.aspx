<%@ Page Language="C#" AutoEventWireup="true" CodeFile="mapinstitutestaff.aspx.cs" Inherits="backoffice_staff_mapinstitutestaff" %>
                ...
                <table border="0" cellpadding="2" cellspacing="2" width="80%">
                    ...
                    <tr>
                        <td align="right" style="width: 15%" valign="top">
                            Institute: <span class="star">*</span> :&nbsp;
                        </td>
                        <asp:Panel ID="panelChk" runat="server">
                            <td align="left" style="width: 85%">
                                <asp:DataList ID="collegelist" runat="server" RepeatDirection="Horizontal" RepeatColumns="2">
                                    <ItemTemplate>
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                            <tr>
