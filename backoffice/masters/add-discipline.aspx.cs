        ...
        try
        {
            ...
            if ((Page.IsValid == true))
            {
                ...
                if ((Conversion.Val(dpid.Text) == 0))
                {
                    ...
                    CKeditor1.ReadOnly = true;
                    CKeditor2.ReadOnly = true;
                    object var = clsm.MasterSave(this, dpid.Parent, 19, mainclass.Mode.modeAdd, "Discipline_MasterSP", Server.HtmlDecode(Convert.ToString(Session["UserId"])));
                    CKeditor1.ReadOnly = false;
                    CKeditor2.ReadOnly = false;
                    if ((File1.PostedFile.FileName != ""))
                    {
                ...
                else
                {
                    ...
                    CKeditor1.ReadOnly = true;
                    CKeditor2.ReadOnly = true;
                    object var = clsm.MasterSave(this, dpid.Parent, 19, mainclass.Mode.modeModify, "Discipline_MasterSP", Server.HtmlDecode(Convert.ToString(Session["UserId"])));
                    CKeditor1.ReadOnly = false;
                    CKeditor2.ReadOnly = false;
                    if ((File1.PostedFile.FileName != ""))
                    {
