<%@ Page Title="" Language="C#" MasterPageFile="~/backoffice/layouts/BackMaster.master" Theme="backtheme" AutoEventWireup="true" CodeFile="add-discipline.aspx.cs" Inherits="backoffice_masters_add_discipline" %>
                    ...
                    <table id="Table2" border="0" cellpadding="1" cellspacing="0" style="width: 100%">
                        <tr>
                            <td align="right" width="15%">
                                Discipline Name<span class="star">*</span> :&nbsp;
                            </td>
                            <td align="left" style="width: 85%">
                                <asp:TextBox ID="dpname" CssClass="box" runat="server" Width="500"></asp:TextBox>
                                <asp:TextBox ID="dpid" runat="server" Visible="False" Width="23px"></asp:TextBox>
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="dpname"
                        ...
                        <tr style="display: none">
                         ...
                         <tr >
                            ...
                            <td align="left" style="width: 85%">
                               <asp:TextBox runat="server" ID="colorcode" CssClass="box" runat="server" Width="500px" />
                            </td>
                        </tr>
                        <tr>
                            <td align="right" width="15%">
