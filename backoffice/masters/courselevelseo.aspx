<%@ Page Language="C#" AutoEventWireup="true" CodeFile="courselevelseo.aspx.cs" Inherits="backoffice_masters_courselevelseo" Theme="backtheme" %>
                ...
                <td align="left" colspan="2">
                    <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                        <tr>
                            <td class="head1">
                               <%-- Add/Edit Media SEO--%>
                                <asp:TextBox ID="levelid" runat="server" Visible="false" Width="33px"></asp:TextBox>
