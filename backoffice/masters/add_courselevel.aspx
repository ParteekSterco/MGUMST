<%@ Page Title="" Language="C#" MasterPageFile="~/backoffice/layouts/BackMaster.master"
    Theme="backtheme" AutoEventWireup="true" CodeFile="add_courselevel.aspx.cs" ValidateRequest="false" Inherits="backoffice_masters_add_courselevel" %>
                    ...
                    <table id="Table2" border="0" cellpadding="1" cellspacing="0" style="width: 100%">
                        <tr>
                            <td align="right" width="15%">
                                Course Level Name<span class="star">*</span> :&nbsp;
                            </td>
                            <td align="left" style="width: 85%">
                                <asp:TextBox ID="levelname" CssClass="box" runat="server" Width="500"></asp:TextBox>
                                <asp:TextBox ID="levelid" runat="server" Visible="False" Width="23px"></asp:TextBox>
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="levelname"
                        ...
                        <tr >
                            ...
                            <td align="left" style="width: 85%">
                                <asp:TextBox ID="code" CssClass="box" runat="server" Width="500px"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td align="right" width="15%">
                            ...
                            <td align="left" style="width: 85%">
                                <asp:TextBox ID="tagname" CssClass="box" runat="server" Width="500"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td align="right" width="15%">
                        ...
                        <tr  style="display:none">
                            ...
                            <td align="left" style="width: 85%">
                                ...
                                <asp:TextBox ID="school_details" runat="server" Visible="False" Width="122px"></asp:TextBox>
                            </td>
                        </tr>
                        ...
                        <tr>
                         ...
                         <tr   style="display:none">
                            ...
                            <td>
                          <asp:TextBox ID="rewrite_url" CssClass="box" runat="server" Width="500" ></asp:TextBox>
                            </td>
                        </tr>
