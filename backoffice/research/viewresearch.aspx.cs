...
public partial class backoffice_research_viewresearch : System.Web.UI.Page
{
    ...
    public void gridshow()
    {
        string strsql = "";
        parameters.Clear();
        strsql = "select a.*,b.ntype from research a left join researchtype b on a.ntypeid=b.ntypeid  where 1=1 ";
        ...
        strsql += " order by  researchsdate desc";
    ...
    protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            Panel pnl_faculty = (Panel)e.Row.FindControl("pnl_faculty");

            Label lblntypeid = (Label)e.Row.FindControl("lblntypeid");

            if (lblntypeid.Text!= "3")
            {
                lnkshowonschool.Visible = false;
            }

            

            if (lit_Eventsid.Text == "7")
            {
    ...
    protected void GridView1_RowCommand1(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "del")
        {
            ...
            parameters.Clear();
            parameters.Add("@researchid", Convert.ToInt32((e.CommandArgument)));
            string strsql = "delete from research where researchid=@researchid";
        ...
        if (e.CommandName == "status")
        {
            ...
            if (lblstatus.Text == "False")
            {
                parameters.Clear();
                parameters.Add("@researchid", Convert.ToInt32(e.CommandArgument));
                string strsql = "update research set status=1 where researchid=@researchid";
                clsm.ExecuteQry_Parameter(strsql, parameters);
            ...
            else if (lblstatus.Text == "True")
            {
                parameters.Clear();
                parameters.Add("@researchid", Convert.ToInt32(e.CommandArgument));
                string strsql = "update research set status=0 where researchid=@researchid";
                clsm.ExecuteQry_Parameter(strsql, parameters);
        ...
        if (e.CommandName == "lnkshowonhome")
        {
            ...
            if (lblshowonhome.Text == "False")
            {
                ...
                parameters.Add("@researchid", Convert.ToInt32(e.CommandArgument));
                string strsql = "update research set showonhome=1 where researchid=@researchid";
                clsm.ExecuteQry_Parameter(strsql, parameters);
            ...
            else if (lblshowonhome.Text == "True")
            {
                ...
                parameters.Clear();
                parameters.Add("@researchid", Convert.ToInt32(e.CommandArgument));
                string strsql = "update research set showonhome=0 where researchid=@researchid";
                clsm.ExecuteQry_Parameter(strsql, parameters);
            }
            gridshow();
            trsuccess.Visible = true;
        ...
        if (e.CommandName == "lnkshowonschool")
        {
            ...
            if (lblshowonschool.Text == "False")
            {
                parameters.Clear();
                parameters.Add("@researchid", Convert.ToInt32(e.CommandArgument));
                string strsql = "update research set showonschool=1 where researchid=@researchid";
                clsm.ExecuteQry_Parameter(strsql, parameters);
            ...
            else if (lblshowonschool.Text == "True")
            {
                parameters.Clear();
                parameters.Add("@researchid", Convert.ToInt32(e.CommandArgument));
                string strsql = "update research set showonschool=0 where researchid=@researchid";
                clsm.ExecuteQry_Parameter(strsql, parameters);
        ...
        if (e.CommandName == "lnkshowongroup")
        {
            ...
            if (lblshowongroup.Text == "False")
            {
                parameters.Clear();
                parameters.Add("@researchid", Convert.ToInt32(e.CommandArgument));
                string strsql = "update research set showongroup=1 where researchid=@researchid";
                clsm.ExecuteQry_Parameter(strsql, parameters);
            ...
            else if (lblshowongroup.Text == "True")
            {
                parameters.Clear();
                parameters.Add("@researchid", Convert.ToInt32(e.CommandArgument));
                string strsql = "update research set showongroup=0 where researchid=@researchid";
                clsm.ExecuteQry_Parameter(strsql, parameters);
        ...
        {
            Response.Redirect("addresearch.aspx?nid=" + Convert.ToInt32(e.CommandArgument));
        }
