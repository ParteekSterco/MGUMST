<%@ Page Title="" Language="C#" MasterPageFile="~/backoffice/layouts/BackMaster.master" Theme="backtheme" AutoEventWireup="true" CodeFile="researchtype.aspx.cs" Inherits="backoffice_research_researchtype" %>
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="S.No.">
                            ...
                            <ItemTemplate>
                               ...
                               <asp:Label ID="Label1" runat="server" Text='<%#(Eval("ntypeid")) %>' Visible="false"></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
