<%@ Page Title="" Language="C#" MasterPageFile="~/backoffice/layouts/BackMaster.master" ValidateRequest="false" AutoEventWireup="true" CodeFile="addresearch.aspx.cs" Inherits="backoffice_research_addresearch" Theme="backtheme" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        window.onload = function () {
            dp_cal = new Epoch('epoch_popup', 'popup', document.getElementById('<%=researchsdate.ClientID%>'));
            dp_cal = new Epoch('epoch_popup', 'popup', document.getElementById('<%=researchedate.ClientID%>'));
        };
    </script>
    <script type="text/javascript">
        $(function () {
    ...
    <div class="content-panel">
        <table id="TABLE1" border="0" cellpadding="1" cellspacing="0" style="width: 100%">
                ...
                <td align="left" colspan="4">
                    <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                        <tr>
                            ...
                            <td align="right">
                                &nbsp;<asp:TextBox ID="researchid" runat="server" Visible="False" Width="33px"></asp:TextBox>
            ...
            <tr>
                <td valign="top" align="right">
                    Research Type<span class="star">*</span> : &nbsp;
                </td>
                <td>
            ...
            <tr>
                ...
                <td align="left" style="width: 85%">
                    <asp:TextBox ID="researchTitle" runat="server" CssClass="box" Width="500"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="researchTitle"
            ...
            <tr>
                <td align="right">
                    Research Location<span class="star"></span> :&nbsp;
                </td>
                <td align="left">
                    <asp:TextBox ID="location" runat="server" CssClass="box" Width="359px"></asp:TextBox>
                </td>
            </tr>
            <tr style="display:none">
                <td valign="top" align="right">
                    Lab Category<span class="star"></span> : &nbsp;
                </td>
                <td>
                    <asp:DropDownList ID="lcid" runat="server" Width="500">
                    </asp:DropDownList>
            ...
            <tr style="display: none">
                ...
                <td align="left">
                    <asp:DropDownList ID="types" runat="server" Width="200px">
            ...
            <tr>
                ...
                <td align="left">
                    <asp:TextBox ID="researchsdate" runat="server" CssClass="box" Width="200px"></asp:TextBox>
        ...
        <tr>
            ...
            <tr style="display: none">
                ...
                <td align="left">
                    <asp:TextBox ID="researchedate" runat="server" CssClass="box" Width="66px" Text="01/01/2000"></asp:TextBox>
            ...
            <tr>
                ...
                <td align="left" colspan="3">
                    ...
                    <asp:TextBox ID="researchDesc" runat="server" Visible="False" Width="122px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td align="right">
            ...
            <tr style="display: none">
                ...
                <td align="left" colspan="3">
                    <asp:TextBox ID="youtube_url" runat="server" Width="243px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td align="right">
