    ...
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (researchid.Text == "")
            {
                ...
                clsm.AddLogHistory(Convert.ToString(Request.Url), Convert.ToString(0), "Add", Convert.ToString(researchTitle.Text), Convert.ToString(var), Convert.ToString("Research"), Convert.ToString(Conversion.Val(Request.QueryString["clid"])), "Research");
            ...
            else
            {
                ...
                clsm.AddLogHistory(Convert.ToString(Request.Url), Convert.ToString(0), "Edit", Convert.ToString(researchTitle.Text), Convert.ToString(var), Convert.ToString("Research"), Convert.ToString(Conversion.Val(Request.QueryString["clid"])), "Research");
