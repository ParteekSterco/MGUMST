    ...
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (indid.Text == "")
            {
                ...
                clsm.AddLogHistory(Convert.ToString(Request.Url), Convert.ToString(0), "Add", Convert.ToString(indTitle.Text), Convert.ToString(var), Convert.ToString("Industrial"), Convert.ToString(collageid.Text), "Industrial");
            ...
            else
            {
                ...
                clsm.AddLogHistory(Convert.ToString(Request.Url), Convert.ToString(0), "Edit", Convert.ToString(indTitle.Text), Convert.ToString(var), Convert.ToString("Industrial"), Convert.ToString(collageid.Text), "Industrial");
