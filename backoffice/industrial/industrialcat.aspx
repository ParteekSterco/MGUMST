<%@ Page Title="" Language="C#" MasterPageFile="~/backoffice/layouts/BackMaster.master" ValidateRequest="false" Theme="backtheme" AutoEventWireup="true" CodeFile="industrialcat.aspx.cs" Inherits="backoffice_industrial_industrialcat" %>
...
<input type="hidden" value="<%=appno%>" name="appno" id="appno">
    ...
    <script type="text/javascript">
      ...
      <h2> Add/Edit Industrial Training Category</h2>
...
<table id="TABLE1" border="0" cellpadding="1" cellspacing="0" style="width: 100%">
        ...
        <tr>
            <td align="right" style="width: 15%; height: 26px;">
               Industrial Training Category<span class="star">*</span> :&nbsp;
            </td>
            <td align="left" style="width: 85%; height: 26px;">
                <asp:TextBox ID="indcattitle" runat="server" CssClass="box" MaxLength="100" TabIndex="3"
                    Width="350px"></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="indcattitle"
