<%@ Page Title="" Language="C#" MasterPageFile="~/backoffice/layouts/BackMaster.master" ValidateRequest="false" AutoEventWireup="true" CodeFile="addindustrial.aspx.cs" Inherits="backoffice_industrial_addindustrial" %>
        ...
        <table id="TABLE1" border="0" cellpadding="1" cellspacing="0" style="width: 100%">
            ...
            <tr>
                <td align="right" colspan="2">
                    ...
                    <asp:TextBox ID="indid" runat="server" Visible="false"></asp:TextBox>
            ...
            <tr>
                <td valign="top" align="right">
                    Industrial Category<span class="star"></span>: &nbsp;
                </td>
                <td>
            ...
            <tr style="display:none;">
                ...
                <td align="left" style="width: 85%">
                    <asp:TextBox ID="indTitle" runat="server" CssClass="box" Width="500"></asp:TextBox>
