<%@ Page Title="" Language="C#" MasterPageFile="~/backoffice/layouts/BackMaster.master"  Theme="backtheme" AutoEventWireup="true" CodeFile="viewindustrial.aspx.cs" Inherits="backoffice_industrial_viewindustrial" %>
...
<input type="hidden" value="<%=appno%>" name="appno" id="appno">
    ...
    <link rel="stylesheet" type="text/css" href="/fancybox/jquery.fancybox-1.3.4.css"
     ...
     <h2>View Industrial Training</h2>
                ...
                <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="DeptName" HeaderText="Department">
                         ...
                         <asp:BoundField DataField="indcattitle" HeaderText="Industrial Category">
                            <HeaderStyle HorizontalAlign="Center" Width="15%" />
                            <ItemStyle HorizontalAlign="Center" Width="15%" />
                        </asp:BoundField>
                        ...
                        <asp:TemplateField HeaderText="Publish">
                            ...
                            <ItemTemplate>
                                ...
                                <asp:ImageButton ID="lnkstatus" CssClass="toptxt" runat="server" CausesValidation="false"
                                    CommandArgument='<%#(Eval("indid")) %>' CommandName="lnkstatus"></asp:ImageButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Edit">
                            ...
                            <ItemStyle HorizontalAlign="Center"  />
                            <ItemTemplate>
                                <asp:ImageButton ID="btnedit" runat="server" CausesValidation="false" CommandArgument='<%#(Eval("indid")) %>'
                        ...
                        <asp:TemplateField HeaderText="Delete">
                            ...
                            <ItemStyle HorizontalAlign="Center"  />
                            <ItemTemplate>
                                <asp:ImageButton ID="btndel" runat="server" CausesValidation="false" CommandArgument='<%#(Eval("indid")) %>'
