        ...
        if (Page.IsValid)
        {
            try
            {
                ...
                if (string.IsNullOrEmpty(albumid.Text))
                {
                    ...
                    clsm.AddLogHistory(Convert.ToString(Request.Url), Convert.ToString(0), "Add", Convert.ToString(AlbumTitle.Text), Convert.ToString(var), Convert.ToString("Album"), Convert.ToString(Conversion.Val(Request.QueryString["clid"])), "Album");
                ...
                else
                {
                    ...
                    clsm.AddLogHistory(Convert.ToString(Request.Url), Convert.ToString(0), "Edit", Convert.ToString(AlbumTitle.Text), Convert.ToString(var), Convert.ToString("Album"), Convert.ToString(Conversion.Val(Request.QueryString["clid"])), "Album");
