        ...
        if (Page.IsValid)
        {
            try
            {
                if (string.IsNullOrEmpty(photoid.Text))
                {
                    ...
                    clsm.AddLogHistory(Convert.ToString(Request.Url), Convert.ToString(0), "Add", Convert.ToString(phototitle.Text), Convert.ToString(var), Convert.ToString("Photo"), Convert.ToString(Conversion.Val(Request.QueryString["clid"])), "Photo");
                ...
                else
                {
                    ...
                    clsm.AddLogHistory(Convert.ToString(Request.Url), Convert.ToString(0), "Edit", Convert.ToString(phototitle.Text), Convert.ToString(var), Convert.ToString("Photo"), Convert.ToString(Conversion.Val(Request.QueryString["clid"])), "Photo");
