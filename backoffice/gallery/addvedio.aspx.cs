        ...
        if (Page.IsValid)
        {
            try
            {
                ...
                if (string.IsNullOrEmpty(vedioid.Text))
                {
                    ...
                    string var = clsm.MasterSave(this, vedioid.Parent, 10, mainclass.Mode.modeAdd, "vedioSP", Convert.ToString(Session["UserId"]));

                    //***************** for log history*********************

                    clsm.AddLogHistory(Convert.ToString(Request.Url), Convert.ToString(0), "Add", Convert.ToString(vediotitle.Text), Convert.ToString(var), Convert.ToString("Video Gallery"), Convert.ToString(Conversion.Val(Request.QueryString["clid"])), "Video Gallery");
                ...
                else
                {
                    ...
                    string var = clsm.MasterSave(this, vedioid.Parent, 10, mainclass.Mode.modeModify, "vedioSP", Convert.ToString(Session["UserId"]));

                    //***************** for log history*********************

                    clsm.AddLogHistory(Convert.ToString(Request.Url), Convert.ToString(0), "Edit", Convert.ToString(vediotitle.Text), Convert.ToString(var), Convert.ToString("Video Gallery"), Convert.ToString(Conversion.Val(Request.QueryString["clid"])), "Video Gallery");
