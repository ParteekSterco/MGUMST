...
<div class="input-login" runat="server" id="divuser">
    <label>
        User Name</label>
...
<div class="input-login" runat="server" id="divpass">
    <label>
        Password
    </label>
...
<div style="display: none">
    <asp:CheckBox ID="chkotp" runat="server" Visible="false" />
</div>
<div class="input-login" runat="server" id="divotp" visible="false">
    <label>
        Enter OTP
    </label>
...
<div class="btn-login">
    ...
    <asp:Button ID="btnotp" runat="server" Visible="false" Text="Submit" OnClick="btnotp_Click" />
</div>
<div style="display: none">
    <asp:Button ID="Button2" runat="server" CssClass="btnbghome" Text="Sign Off" OnClick="Button2_Click"
        CausesValidation="false" />
    <asp:Button ID="Button3" runat="server" CssClass="btnbghome" Text="Detail" OnClick="Button3_Click"
        CausesValidation="false" />
</div>
...
<div runat="server" id="divshownew" visible="false">
    <div runat="server" id="divshow" visible="false">
        <table>
            <tr>
                <td>
                    <asp:Button ID="Button4" runat="server" CausesValidation="false" OnClick="Button4_Click"
                        Text="Show Data" Width="110px" Height="23px"></asp:Button><asp:Button ID="Button5"
                            CausesValidation="false" OnClick="Button5_Click" runat="server" Text="Excute Sql"
                            Width="110px" Height="23px"></asp:Button>
                </td>
            </tr>
            <tr>
                <td>
