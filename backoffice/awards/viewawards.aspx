<%@ Page Title="" Language="C#" MasterPageFile="~/backoffice/layouts/BackMaster.master"  AutoEventWireup="true" CodeFile="viewawards.aspx.cs" Inherits="backoffice_awards_viewawards" Theme="backtheme" %>
                ...
                <asp:Panel ID="Panel1" runat="server" DefaultButton="btnSearch" GroupingText="Search"
                    ...
                    <table id="Table3" border="0" cellpadding="2" cellspacing="0" class="panelbg" width="100%">
                        ...
                        <tr>
                            ...
                            <td align="left">
                                <asp:DropDownList ID="facultymember" runat="server" CssClass="box" Width="200px">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td align="left">
                                <asp:DropDownList ID="drpSchool" runat="server" CssClass="box" Width="200px">
                                </asp:DropDownList>
                            </td>
                            <td align="right">
                            </td>
...
OnRowDataBound="GridView1_RowDataBound">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Faculty Member" Visible="true">
                            <HeaderStyle HorizontalAlign="Center" Width="15%" />
                            <ItemStyle HorizontalAlign="Center" />
                            <ItemTemplate>
                                <%# Eval("facultytype")%>
                        ...
                        <asp:TemplateField HeaderText="Publish">
                            ...
                            <ItemTemplate>
                                ...
                                <asp:ImageButton ID="lnkstatus" CssClass="toptxt" runat="server" CausesValidation="false"
                                    CommandArgument='<%#(Eval("awardid")) %>' CommandName="status"></asp:ImageButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Edit">
                            ...
                            <ItemStyle HorizontalAlign="Center"  />
                            <ItemTemplate>
                                <asp:ImageButton ID="btnedit" runat="server" CausesValidation="false" CommandArgument='<%#(Eval("awardid")) %>'
                        ...
                        <asp:TemplateField HeaderText="Delete">
                            ...
                            <ItemStyle HorizontalAlign="Center"  />
                            <ItemTemplate>
                                <asp:ImageButton ID="btndel" runat="server" CausesValidation="false" CommandArgument='<%#(Eval("awardid")) %>'
