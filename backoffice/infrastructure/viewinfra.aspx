<%@ Page Title="" Language="C#" MasterPageFile="~/backoffice/layouts/BackMaster.master" Theme="backtheme" AutoEventWireup="true" CodeFile="viewinfra.aspx.cs" Inherits="backoffice_infrastructure_viewinfra" %>
            ...
            <td align="center" colspan="2">
                <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="infcattitle" Visible="false" HeaderText="Infrastucture Category">
                            <HeaderStyle HorizontalAlign="Center" Width="15%" />
                            <ItemStyle HorizontalAlign="Center" Width="15%" />
                        </asp:BoundField>

                          <asp:BoundField DataField="infTitle" HeaderText="Title">
                            <HeaderStyle HorizontalAlign="Center" Width="15%" />
                            <ItemStyle HorizontalAlign="Center" Width="15%" />
                        </asp:BoundField>
                        ...
                        <asp:TemplateField HeaderText="Show on Group">
                            <HeaderStyle HorizontalAlign="Center" Width="5%" />
                            <ItemStyle HorizontalAlign="Center"  />
                            <ItemTemplate>
                                ...
                                <asp:ImageButton ID="lnkshowongroup" CssClass="toptxt" runat="server" CausesValidation="false"
                                    CommandArgument='<%#(Eval("infid")) %>' CommandName="lnkshowongroup"></asp:ImageButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                       ...
                       <asp:TemplateField HeaderText="Map Testimonials" Visible="true">
                            ...
                            <ItemStyle HorizontalAlign="Center" />
                            <ItemTemplate>
                                <asp:Literal Text='<%# Eval("infid")%>' ID="litcid" Visible="false" runat="server" />
                                <asp:Panel runat="server" ID="pnl_gallery" Visible="true">
                                    <a class="toptxtinf" visible="false"
                                        href='mapinfratestimonials.aspx?infid=<%#Eval("infid")%>'>
                        ...
                        <asp:TemplateField HeaderText="Publish">
                            ...
                            <ItemTemplate>
                                ...
                                <asp:ImageButton ID="lnkstatus" CssClass="toptxt" runat="server" CausesValidation="false"
                                    CommandArgument='<%#(Eval("infid")) %>' CommandName="lnkstatus"></asp:ImageButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Edit">
                            ...
                            <ItemStyle HorizontalAlign="Center"  />
                            <ItemTemplate>
                                <asp:ImageButton ID="btnedit" runat="server" CausesValidation="false" CommandArgument='<%#(Eval("infid")) %>'
                        ...
                        <asp:TemplateField HeaderText="Delete">
                            ...
                            <ItemStyle HorizontalAlign="Center"  />
                            <ItemTemplate>
                                <asp:ImageButton ID="btndel" runat="server" CausesValidation="false" CommandArgument='<%#(Eval("infid")) %>'
