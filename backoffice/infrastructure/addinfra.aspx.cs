    ...
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (infid.Text == "")
            {
                ...
                clsm.AddLogHistory(Convert.ToString(Request.Url), Convert.ToString(0), "Add", Convert.ToString(infTitle.Text), Convert.ToString(var), Convert.ToString("infrastructure"), Convert.ToString(collageid.Text), "infrastructure");
            ...
            else
            {
                ...
                clsm.AddLogHistory(Convert.ToString(Request.Url), Convert.ToString(0), "Edit", Convert.ToString(infTitle.Text), Convert.ToString(var), Convert.ToString("infrastructure"), Convert.ToString(collageid.Text), "infrastructure");
