<%@ Page Language="C#" AutoEventWireup="true" CodeFile="mapinfratestimonials.aspx.cs" Inherits="backoffice_infrastructure_mapinfratestimonials" %>
                ...
                <table border="0" cellpadding="2" cellspacing="2" width="80%">
                    ...
                    <tr>
                        ...
                        <asp:Panel ID="panelChk" runat="server">
                            <td align="left" style="width: 85%">
                                <asp:DataList ID="testimoniallist" runat="server" RepeatDirection="Horizontal" RepeatColumns="2">
                                    <ItemTemplate>
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                            <tr>
