<%@ Page Title="" Language="C#" MasterPageFile="~/backoffice/layouts/BackMaster.master" Theme="backtheme" AutoEventWireup="true" CodeFile="infracat.aspx.cs" Inherits="backoffice_infrastructure_infracat" %>
...
<input type="hidden" value="<%=appno%>" name="appno" id="appno">
    ...
    <script type="text/javascript">
      ...
      <h2> Add/Edit Infrastructure Category</h2>
...
<table id="TABLE1" border="0" cellpadding="1" cellspacing="0" style="width: 100%">
        ...
        <tr>
            ...
            <td align="left" style="width: 85%; height: 26px;">
                <asp:TextBox ID="infcattitle" runat="server" CssClass="box" MaxLength="100" TabIndex="3"
                    Width="350px"></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="infcattitle"
