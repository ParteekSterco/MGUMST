<%@ Page Title="" Language="C#" MasterPageFile="~/backoffice/layouts/BackMaster.master"  ValidateRequest="false"  Theme="backtheme" AutoEventWireup="true" CodeFile="addinfra.aspx.cs" Inherits="backoffice_infrastructure_addinfra" %>
        ...
        <table id="TABLE1" border="0" cellpadding="1" cellspacing="0" style="width: 100%">
            ...
            <tr>
                <td align="right" colspan="2">
                    ...
                    <asp:TextBox ID="infid" runat="server" Visible="false"></asp:TextBox>
            ...
            <tr>
                ...
                <td>
                   ...
                   <%--    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" InitialValue="0" ControlToValidate="deptid"
                        Display="Dynamic" ErrorMessage="Required"></asp:RequiredFieldValidator>--%>
                </td>
            </tr>
            <tr style="display:none">
                <td valign="top" align="right">
                    Infrastructure Category<span class="star">*</span>: &nbsp;
                </td>
                <td>
                    <asp:DropDownList ID="lcid" runat="server" Width="350px">
                    </asp:DropDownList>
                <%--    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" InitialValue="0" ControlToValidate="lcid"
                        Display="Dynamic" ErrorMessage="Required"></asp:RequiredFieldValidator>--%>
                </td>
            </tr>
            <tr >
                ...
                <td align="left" style="width:85%">
                    <asp:TextBox ID="infTitle" runat="server" CssClass="box" Width="359px"></asp:TextBox>
                     <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="infTitle"
                        Display="Dynamic" ErrorMessage="Required"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr style="display: none">
            ...
            <tr >
                ...
                <td align="left">
                    <input id="File4" runat="server" style="Width:359px" contenteditable="false" type="file" class="box" />
                    <br />
                    <%--    <asp:Label
