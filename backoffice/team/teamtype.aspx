<%@ Page Title="" Language="C#" MasterPageFile="~/backoffice/layouts/BackMaster.master" Theme="backtheme" AutoEventWireup="true" CodeFile="teamtype.aspx.cs" Inherits="backoffice_team_teamtype" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   ...
   <input type="hidden" value="<%=appno%>" name="appno" id="appno">
    ...
    <script type="text/javascript">
      ...
      <h2> Add/Edit Leadership Type</h2>
...
<table id="TABLE1" border="0" cellpadding="1" cellspacing="0" style="width: 100%">
            ...
            <td align="left" colspan="2">
                <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                    <tr>
                        ...
                        <td align="right" >
                            &nbsp;
                            <asp:TextBox ID="ttypeid" runat="server" Visible="False" Width="33px"></asp:TextBox>
        ...
        <tr>
            ...
            <td align="left" style="width: 85%; height: 26px;">
                <asp:TextBox ID="ttype" runat="server" CssClass="box" MaxLength="100" TabIndex="3"
                    Width="214px"></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="ttype"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="S.No.">
                            ...
                            <ItemTemplate>
                               ...
                               <asp:Label ID="Label1" runat="server" Text='<%#(Eval("ttypeid")) %>' Visible="false"></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Publish">
                            ...
                            <asp:TextBox ID="txtstatus" runat="server" Text='<%#Eval("status") %>' Visible="false"></asp:TextBox>
                                <asp:ImageButton ID="lnkstatus" CssClass="toptxt" runat="server" CausesValidation="false"
                                    CommandArgument='<%#(Eval("ttypeid")) %>' CommandName="status"></asp:ImageButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Edit">
                            ...
                            <ItemStyle HorizontalAlign="Center" />
                            <ItemTemplate>
                                <asp:ImageButton ID="btnedit" runat="server" CausesValidation="false" CommandArgument='<%#(Eval("ttypeid")) %>'
                        ...
                        <asp:TemplateField HeaderText="Delete" Visible="false">
                            ...
                            <ItemStyle HorizontalAlign="Center" />
                            <ItemTemplate>
                                <asp:ImageButton ID="btndel" runat="server" CausesValidation="false" CommandArgument='<%#(Eval("ttypeid")) %>'
