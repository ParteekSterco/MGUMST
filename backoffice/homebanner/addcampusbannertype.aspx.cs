        ...
        if (Page.IsValid)
        {
            try
            {
                ...
                if (Conversion.Val(btypeid.Text) == 0)
                {
                    ...
                    string var=clsm.MasterSave(this, btypeid.Parent, 6, mainclass.Mode.modeAdd, "campushomebannertypeSP", Server.HtmlDecode(Convert.ToString(Session["UserId"])));
                    ...
                    clsm.AddLogHistory(Convert.ToString(Request.Url), Convert.ToString(0), "Add", Convert.ToString(btype.SelectedValue), Convert.ToString(var), Convert.ToString("Banner Type"), Convert.ToString(Conversion.Val(Request.QueryString["clid"])), Convert.ToString(lblcollage.Text));
                ...
                {
                    string var = clsm.MasterSave(this, btypeid.Parent, 6, mainclass.Mode.modeModify, "campushomebannertypeSP", Server.HtmlDecode(Convert.ToString(Session["UserId"])));

                    //***************** for log history*********************

                    clsm.AddLogHistory(Convert.ToString(Request.Url), Convert.ToString(0), "Edit", Convert.ToString(btype.SelectedValue), Convert.ToString(var), Convert.ToString("Banner Type"), Convert.ToString(Conversion.Val(Request.QueryString["clid"])), Convert.ToString(lblcollage.Text));
