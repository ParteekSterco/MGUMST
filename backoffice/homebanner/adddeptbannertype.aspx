<%@ Page Title="" Language="C#" MasterPageFile="~/backoffice/layouts/BackMaster.master" AutoEventWireup="true" CodeFile="adddeptbannertype.aspx.cs" Inherits="backoffice_homebanner_adddeptbannertype" Theme="backtheme" %>
            ...
            <td align="left" style="width: 85%; height: 26px;">
                ...
                <asp:ListItem Value="Banner">Banner</asp:ListItem>
                  <asp:ListItem Value="Video">Video</asp:ListItem>
                    <asp:ListItem Value="News Banner">News Banner</asp:ListItem>
                </asp:DropDownList>
