<%@ Page Language="C#" MasterPageFile="~/backoffice/layouts/BackMaster.master" AutoEventWireup="true"
    CodeFile="viewhomebanner.aspx.cs"  Inherits="backoffice_homebanner_viewhomebanner"
    Theme="backtheme" %>
        ...
        <table id="TABLE2" border="0" cellpadding="1" cellspacing="0" style="width: 100%">
            <tr>
                ...
                <tr style="display:none;">
                 ...
                 <tr >
                 <td colspan="2">
                  <table id="TABLE3" border="0" cellpadding="1" cellspacing="0" style="width: 80%">
                  <tr>
                    ...
                    <td align="left" style="width: 25%">
                        <asp:DropDownList ID="devicetype" runat="server" Width="200px">
                    ...
                    <td align="left" style="width: 25%">
                        <asp:DropDownList ID="btypeid" runat="server" Width="200px"></asp:DropDownList>
                    </td>
                    ...
                    <td align="center" colspan="2">
                        <asp:GridView ID="GridView1" runat="server" PageSize="50" AllowPaging="True" Width="100%"
                            ...
                            <ItemStyle HorizontalAlign="center" Width="20%" />
                                ...
                                <asp:BoundField DataField="Trdate" DataFormatString="{0: dd/MM/yyyy}" HeaderText="Upload Date" Visible="false">
                                    <ItemStyle Width="10%" />
                                </asp:BoundField>
                                <asp:BoundField DataField="displayorder" HeaderText="Display Order">
                                 ...
                                 <asp:TemplateField HeaderText="Banner Start Date" Visible="false">
                                    <ItemStyle Width="6%" />
                                    <ItemTemplate>
                                         <asp:Literal ID="litstartdate" runat="server" Text='<%#Eval("bannerstartdate", "{0:dd/MM/yyyy}")%>'></asp:Literal>
                                    </ItemTemplate>
                                </asp:TemplateField>

                                
                                 <asp:TemplateField HeaderText="Banner End Date" Visible="false">
                                    <ItemStyle Width="6%" />
                                    <ItemTemplate>
                                         <asp:Literal ID="litenddate" runat="server" Text='<%#Eval("bannerenddate", "{0:dd/MM/yyyy}")%>'></asp:Literal>
                                    </ItemTemplate>
                                </asp:TemplateField>
