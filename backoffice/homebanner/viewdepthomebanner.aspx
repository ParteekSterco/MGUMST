<%@ Page Title="" Language="C#" MasterPageFile="~/backoffice/layouts/BackMaster.master" AutoEventWireup="true" CodeFile="viewdepthomebanner.aspx.cs" Inherits="backoffice_homebanner_viewdepthomebanner" Theme="backtheme" %>
        ...
        <table id="TABLE2" border="0" cellpadding="1" cellspacing="0" style="width: 100%">
            <tr>
                ...
                <td width="70%" align="right">
                      <a href="/backoffice/department/viewdepartment.aspx" style="color: White"><b>Back To Department</b></a>&nbsp;
                </td>
            </tr>
        </table>
    </td>
