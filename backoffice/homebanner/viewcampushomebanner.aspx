<%@ Page Title="" Language="C#" MasterPageFile="~/backoffice/layouts/BackMaster.master" Theme="backtheme" AutoEventWireup="true" CodeFile="viewcampushomebanner.aspx.cs" Inherits="backoffice_homebanner_viewcampushomebanner" %>
        ...
        <table id="TABLE2" border="0" cellpadding="1" cellspacing="0" style="width: 100%">
            <tr>
                ...
                <td width="70%" align="right">
                      <a href="/backoffice/campus/viewcentres.aspx" style="color: White"><b>Back To Campus</b></a>&nbsp;
                </td>
            </tr>
        </table>
    </td>
