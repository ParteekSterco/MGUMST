<%@ Page Title="" Language="C#" MasterPageFile="~/layouts/inner.master" AutoEventWireup="true" CodeFile="course-list.aspx.cs" Inherits="course_list" %>
                        ...
                        <ul>
                            <asp:Repeater ID="rptcollage" runat="server" OnItemDataBound="rptcollage_ItemDataBound">
                                <ItemTemplate>
                                    ...
                                    <li id="l1" runat="server"><a id="ank" runat="server"><%#Eval("collagename")%></a></li>
                                </ItemTemplate>
                            </asp:Repeater>
                        </ul>
                    </div>
                ...
                <div class="col-lg-9">
                    <div class="mgu_course_tab">
                        <div class="program_list">
                            <ul>
                                <li id="l1_all" runat="server"><a href="/course-list.aspx?mpgid=126&pgidtrail=126&levelid=all">All <span>Programs</span></a></li>
                        ...
                        <div class="course_search_box">
                            ...
                            <asp:LinkButton ID="lnk" runat="server" class="btn">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-2 col-md-2 text-end">
                                                        <a href="#" class="arrowBtn">
                                                            <img src="/assets/images/icons/arrowCircledowndark.svg"
                                                                alt="" class="img-fluid">
                                                        </a>
                                                    </div>
                                                    <div class="col-md-4">
